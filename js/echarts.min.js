!function (t, e) {
    ...
    function l() {
        return lp || (lp = sp().getContext("2d")), lp
    }
    ...
    function f(t, e, n) {
        if (t && e) if (t.forEach && t.forEach === ep) t.forEach(e, n); else if (t.length === +t.length) for (var i = 0, r = t.length; r > i; i++) e.call(n, t[i], i, t); else for (var a in t) t.hasOwnProperty(a) && e.call(n, t[a], a, t)
    }
    ...
    function ge(t, e, n, i, r) {
        if (e.getBoundingClientRect && Kf.domSupported && !ye(e)) {
            var a = e[xp] || (e[xp] = {}), o = ve(e, a), s = me(o, a, r);
    ...
    function _e(t, e, n, i) {
        return n = n || {}, i || !Kf.canvasSupported ? xe(t, e, n) : Kf.browser.firefox && null != e.layerX && e.layerX !== e.offsetX ? (n.zrX = e.layerX, n.zrY = e.layerY) : null != e.offsetX ? (n.zrX = e.offsetX, n.zrY = e.offsetY) : xe(t, e, n), n
    }
    ...
    function xe(t, e, n) {
        if (Kf.domSupported && t.getBoundingClientRect) {
            ...
            if (ge(Mp, t, i, r)) return n.zrX = Mp[0], void (n.zrY = Mp[1])
        }
        n.zrX = n.zrY = 0
    }
    ...
    function be(t, e, n) {
        ...
        var o = e.button;
        return null == e.which && void 0 !== o && Sp.test(e.type) && (e.which = 1 & o ? 1 : 2 & o ? 3 : 4 & o ? 2 : 0), e
    }
    ...
    function Qe(t, e) {
        jp && $e(jp, e), jp = qp.put(t, jp || e.slice())
    }
    ...
    function Je(t, e) {
        if (t) {
            ...
            if (i in Up) return $e(e, Up[i]), Qe(t, e), e;
            if ("#" !== i.charAt(0)) {
    ...
    function on(t, e, n) {
        if (e && e.length && t >= 0 && 1 >= t) {
            var i = t * (e.length - 1), r = Math.floor(i), a = Math.ceil(i), o = Je(e[r]), s = Je(e[a]), l = i - r,
    ...
    function pn(t, e, n, i, r) {
        var a = t.length;
        if (1 === r) for (var o = 0; a > o; o++) i[o] = dn(t[o], e[o], n); else for (var s = a && t[0].length, o = 0; a > o; o++) for (var l = 0; s > l; l++) i[o][l] = dn(t[o][l], e[o][l], n)
    }
    ...
    function gn(t, e, n) {
        ...
        if (i !== r) {
            var a = i > r;
            if (a) t.length = r; else for (var o = i; r > o; o++) t.push(1 === n ? e[o] : Qp.call(e[o]))
        }
    ...
    function mn(t, e, n, i, r, a, o, s, l) {
        var u = t.length;
        if (1 === l) for (var h = 0; u > h; h++) s[h] = yn(t[h], e[h], n[h], i[h], r, a, o); else for (var c = t[0].length, h = 0; u > h; h++) for (var d = 0; c > d; d++) s[h][d] = yn(t[h][d], e[h][d], n[h][d], i[h][d], r, a, o)
    }
        ...
        if (u) {
            ...
            if (a || !x) {
                ...
                var B = function (t, e) {
                    ...
                    P = n, L = e;
                    var i = m[n + 1] - m[n];
                    if (0 !== i) if (T = (e - m[n]) / i, l) if (D = y[n], C = y[0 === n ? n : n - 1], A = y[n > u - 2 ? u - 1 : n + 1], k = y[n > u - 3 ? u - 1 : n + 2], f) mn(C, D, A, k, T, T * T, T * T * T, o(t, r), v); else {
                        var a;
                        if (p) a = mn(C, D, A, k, T, T * T, T * T * T, O, 1), a = xn(O); else {
                            if (g) return fn(D, A, T);
                            a = yn(C, D, A, k, T, T * T, T * T * T)
                        }
                        s(t, r, a)
                    } else if (f) pn(y[n], y[n + 1], T, o(t, r), v); else {
                        var a;
                        if (p) pn(y[n], y[n + 1], T, O, 1), a = xn(O); else {
                            if (g) return fn(y[n], y[n + 1], T);
                            a = dn(y[n], y[n + 1], T)
                        }
                        s(t, r, a)
                    }
                }, E = new Ge({target: t._target, life: h, loop: t._loop, delay: t._delay, onframe: B, ondestroy: n});
    ...
    function Bn(t, e, n, i) {
        ...
        if (!(2 > r)) {
            var a = 0;
            if (cg > r) return a = Dn(t, n, i, e), void kn(t, n, i, n + a, e);
            var o = new On(t, e), s = Cn(r);
            do {
                if (a = Dn(t, n, i, e), s > a) {
                    var l = r;
    ...
    function Fn(t, e, n) {
        var i = sp(), r = e.getWidth(), a = e.getHeight(), o = i.style;
    ...
    function Hn(t, e, n, i, r) {
        if (t) {
            if ("string" == typeof t) {
                ...
                var a = Tg.get(t), o = {hostEl: n, cb: i, cbPayload: r};
    ...
    function Xn(t, e) {
        ...
        return Dg > Ag && (Dg = 0, Cg = {}), Dg++, Cg[n] = r, r
    }
    ...
    function Un(t, e, n, i, r, a, o) {
        var s = ii(t, e, r, a, o), l = Xn(t, e);
        r && (l += r[1] + r[3]);
        var u = s.outerHeight, h = jn(0, l, n), c = Zn(0, u, i), d = new Tn(h, c, l, u);
    ...
    function qn(t, e, n, i, r, a, o, s) {
        var l = ri(t, {rich: o, truncate: s, font: e, textAlign: n, textPadding: r, textLineHeight: a}),
            u = l.outerWidth, h = l.outerHeight, c = jn(0, u, n), d = Zn(0, h, i);
    ...
    function ii(t, e, n, i, r) {
        null != t && (t += "");
        var a = A(i, ei(e)), o = t ? t.split("\n") : [], s = o.length * a, l = s, u = !0;
        if (n && (l += n[0] + n[2]), t && r) {
            u = !1;
            var h = r.outerHeight, c = r.outerWidth;
            if (null != h && l > h) t = "", o = []; else if (null != c) for (var d = Qn(c - (n ? n[1] + n[3] : 0), e, r.ellipsis, {
                minChar: r.minChar,
    ...
    function ri(t, e) {
        ...
        for (var i, r = kg.lastIndex = 0; null != (i = kg.exec(t));) {
            var a = i.index;
            a > r && ai(n, t.substring(r, a)), ai(n, i[2], i[1]), r = kg.lastIndex
        }
        ...
        for (var p = 0; p < o.length; p++) {
            for (var g = o[p], v = 0, m = 0, y = 0; y < g.tokens.length; y++) {
                var _ = g.tokens[y], x = _.styleName && e.rich[_.styleName] || {}, w = _.textPadding = x.textPadding,
                    b = _.font = x.font || e.font, S = _.textHeight = A(x.textHeight, ei(b));
    ...
    function ui(t) {
        if (t) {
            t.font = oi(t);
            var e = t.textAlign;
            "middle" === e && (e = "center"), t.textAlign = null == e || Bg[e] ? e : "left";
            var n = t.textVerticalAlign || t.textBaseline;
            "center" === n && (n = "middle"), t.textVerticalAlign = null == n || Eg[n] ? n : "top";
            var i = t.textPadding;
    ...
    function ci(t, e, n, i, r, a) {
        var o, s = vi(i), l = !1, u = e.__attrCachedBy === vg.PLAIN_TEXT;
        ...
        var g = p.outerHeight, v = p.lines, m = p.lineHeight, y = _i(Ng, t, i, r), _ = y.baseX, x = y.baseY,
            w = y.textAlign || "left", b = y.textVerticalAlign;
        pi(e, i, r, _, x);
        var S = Zn(x, g, b), M = _, I = S;
        if (s || d) {
            var T = Xn(n, c), C = T;
            d && (C += d[1] + d[3]);
            var D = jn(_, C, w);
        ...
        for (var A = 0; A < zg.length; A++) {
            var k = zg[A], P = k[0], L = k[1], O = i[P];
            l && O === o[P] || (e[L] = gg(e, L, O || k[2]))
        }
        I += m / 2;
        var B = i.textStrokeWidth, E = l ? o.textStrokeWidth : null, z = !l || B !== E,
            R = !l || z || i.textStroke !== o.textStroke, N = wi(i.textStroke, B), F = bi(i.textFill);
    ...
    function fi(t, e, n, i, r) {
        var a = n.width, o = n.outerWidth, s = n.outerHeight, l = i.textPadding, u = _i(Ng, t, i, r), h = u.baseX,
            c = u.baseY, d = u.textAlign, f = u.textVerticalAlign;
        pi(e, i, r, h, c);
        var p = jn(h, o, d), g = Zn(c, s, f), v = p, m = g;
        l && (v += l[3], m += l[0]);
        var y = v + a;
    ...
    function gi(t, e, n, i, r, a, o, s) {
        ...
        var c = n.textPadding;
        c && (o = Mi(o, s, c), h -= n.height / 2 - c[2] - n.textHeight / 2), xi(e, "shadowBlur", k(l.textShadowBlur, i.textShadowBlur, 0)), xi(e, "shadowColor", l.textShadowColor || i.textShadowColor || "transparent"), xi(e, "shadowOffsetX", k(l.textShadowOffsetX, i.textShadowOffsetX, 0)), xi(e, "shadowOffsetY", k(l.textShadowOffsetY, i.textShadowOffsetY, 0)), xi(e, "textAlign", s), xi(e, "textBaseline", "middle"), xi(e, "font", n.font || Og);
        var d = wi(l.textStroke || i.textStroke, p), f = bi(l.textFill || i.textFill),
    ...
    function _i(t, e, n, i) {
        ...
        if (i) {
            ...
            if (l instanceof Array) r = i.x + Si(l[0], i.width), a = i.y + Si(l[1], i.height); else {
    ...
    function Ti(t) {
        ...
        this.style = new _g(t.style, this), this._rect = null, this.__clipPaths = null
    }
    ...
    function ki(t, e, n) {
        return Yg.copy(t.getBoundingRect()), t.transform && Yg.applyTransform(t.transform), Ug.width = e, Ug.height = n, !Yg.intersect(Ug)
    }
    ...
    function Hi(t, e) {
        var n = e.domHandlers;
        Kf.pointerEventsSupported ? f($g.pointer, function (i) {
            Wi(e, i, function (e) {
                n[i].call(t, e)
            })
        }) : (Kf.touchEventsSupported && f($g.touch, function (i) {
            Wi(e, i, function (r) {
                n[i].call(t, r), zi(e)
            })
        }), f($g.mouse, function (i) {
            Wi(e, i, function (r) {
    ...
    function qi(t, e) {
        yp.call(this), this.dom = t, this.painterRoot = e, this._localHandlerScope = new Ui(t, tv), Kg && (this._globalHandlerScope = new Ui(document, ev)), this._pointerCapturing = !1, this._mayPointerCapture = null, Hi(this, this._localHandlerScope)
    }
    ...
    function rr(t) {
        ...
        uv(t, function (t) {
            ...
            if (hv(r)) {
                if (a.name = null != r.name ? r.name + "" : i ? i.name : dv + n, i) a.id = i.id; else if (null != r.id) a.id = r.id + ""; else {
                    var o = 0;
    ...
    function pr(t) {
        var e = {main: "", sub: ""};
        return t && (t = t.split(gv), e.main = t[0] || "", e.sub = t[1] || ""), e
    }
    ...
    function xr(t, e) {
        function n(t) {
            var e = i[t.main];
            return e && e[vv] || (e = i[t.main] = {}, e[vv] = !0), e
        }
        ...
        if (t.registerClass = function (t, e) {
            ...
            t = pr(t);
            var e = [], n = i[t.main];
            return n && n[vv] ? f(n, function (t, n) {
                n !== vv && e.push(t)
            }) : e.push(n), e
    ...
    function Ir(t, e, n, i, r, a) {
        ...
        if (wr(h) && wr(c)) if (wr(s)) a[0] = 0; else {
            ...
            if (wr(g)) {
                ...
                var y = Mv(g), _ = h * s + 1.5 * o * (-c + y), x = h * s + 1.5 * o * (-c - y);
                _ = 0 > _ ? -Sv(-_, Dv) : Sv(_, Dv), x = 0 > x ? -Sv(-x, Dv) : Sv(x, Dv);
                var p = (-s - (_ + x)) / (3 * o);
                p >= 0 && 1 >= p && (a[f++] = p)
            } else {
                var w = (2 * h * s - 3 * o * c) / (2 * Mv(h * h * h)), b = Math.acos(w) / 3, S = Mv(h), M = Math.cos(b),
                    p = (-s - 2 * S * M) / (3 * o), m = (-s + S * (M + Cv * Math.sin(b))) / (3 * o),
    ...
    function Tr(t, e, n, i, r) {
        ...
        if (wr(o)) {
            ...
            if (wr(h)) r[0] = -a / (2 * o); else if (h > 0) {
                var c = Mv(h), u = (-a + c) / (2 * o), d = (-a - c) / (2 * o);
    ...
    function Dr(t, e, n, i, r, a, o, s, l, u, h) {
        ...
        Av[0] = l, Av[1] = u;
        for (var y = 0; 1 > y; y += .05) kv[0] = Sr(t, n, r, o, y), kv[1] = Sr(e, i, a, s, y), p = gp(Av, kv), m > p && (c = y, m = p);
        m = 1 / 0;
        for (var _ = 0; 32 > _ && !(Tv > v); _++) d = c - v, f = c + v, kv[0] = Sr(t, n, r, o, d), kv[1] = Sr(e, i, a, s, d), p = gp(kv, Av), d >= 0 && m > p ? (c = d, m = p) : (Pv[0] = Sr(t, n, r, o, f), Pv[1] = Sr(e, i, a, s, f), g = gp(Pv, Av), 1 >= f && m > g ? (c = f, m = g) : v *= .5);
        return h && (h[0] = Sr(t, n, r, o, c), h[1] = Sr(e, i, a, s, c)), Mv(m)
    }
    ...
    function Pr(t, e, n, i, r) {
        ...
        if (wr(a)) {
            ...
            if (wr(h)) {
                ...
                var c = Mv(h), u = (-o + c) / (2 * a), d = (-o - c) / (2 * a);
                u >= 0 && 1 >= u && (r[l++] = u), d >= 0 && 1 >= d && (r[l++] = d)
            }
        }
        return l
    ...
    function Br(t, e, n, i, r, a, o, s, l) {
        ...
        for (var d = 0; 1 > d; d += .05) {
            kv[0] = Ar(t, n, r, d), kv[1] = Ar(e, i, a, d);
            var f = gp(Av, kv);
            c > f && (u = d, c = f)
        }
        c = 1 / 0;
        for (var p = 0; 32 > p && !(Tv > h); p++) {
            var g = u - h, v = u + h;
            kv[0] = Ar(t, n, r, g), kv[1] = Ar(e, i, a, g);
            var f = gp(kv, Av);
            if (g >= 0 && c > f) u = g, c = f; else {
                Pv[0] = Ar(t, n, r, v), Pv[1] = Ar(e, i, a, v);
                var m = gp(Pv, Av);
                1 >= v && c > m ? (u = v, c = m) : h *= .5
            }
        }
        return l && (l[0] = Ar(t, n, r, u), l[1] = Ar(e, i, a, u)), Mv(c)
    }

    function Er(t, e, n) {
        if (0 !== t.length) {
            var i, r = t[0], a = r[0], o = r[0], s = r[1], l = r[1];
            for (i = 1; i < t.length; i++) r = t[i], a = Lv(a, r[0]), o = Ov(o, r[0]), s = Lv(s, r[1]), l = Ov(l, r[1]);
            e[0] = a, e[1] = s, n[0] = o, n[1] = l
        }
    }

    function zr(t, e, n, i, r, a) {
        r[0] = Lv(t, n), r[1] = Lv(e, i), a[0] = Ov(t, n), a[1] = Ov(e, i)
    }

    function Rr(t, e, n, i, r, a, o, s, l, u) {
        var h, c = Tr, d = Sr, f = c(t, n, r, o, Vv);
        for (l[0] = 1 / 0, l[1] = 1 / 0, u[0] = -1 / 0, u[1] = -1 / 0, h = 0; f > h; h++) {
            var p = d(t, n, r, o, Vv[h]);
            l[0] = Lv(p, l[0]), u[0] = Ov(p, u[0])
        }
        for (f = c(e, i, a, s, Hv), h = 0; f > h; h++) {
            var g = d(e, i, a, s, Hv[h]);
            l[1] = Lv(g, l[1]), u[1] = Ov(g, u[1])
        }
        l[0] = Lv(t, l[0]), u[0] = Ov(t, u[0]), l[0] = Lv(o, l[0]), u[0] = Ov(o, u[0]), l[1] = Lv(e, l[1]), u[1] = Ov(e, u[1]), l[1] = Lv(s, l[1]), u[1] = Ov(s, u[1])
    }

    function Nr(t, e, n, i, r, a, o, s) {
        var l = Lr, u = Ar, h = Ov(Lv(l(t, n, r), 1), 0), c = Ov(Lv(l(e, i, a), 1), 0), d = u(t, n, r, h),
            f = u(e, i, a, c);
        o[0] = Lv(t, r, d), o[1] = Lv(e, a, f), s[0] = Ov(t, r, d), s[1] = Ov(e, a, f)
    }

    function Fr(t, e, n, i, r, a, o, s, l) {
        var u = oe, h = se, c = Math.abs(r - a);
        if (1e-4 > c % zv && c > 1e-4) return s[0] = t - n, s[1] = e - i, l[0] = t + n, void (l[1] = e + i);
    ...
    function Xr(t, e, n, i, r, a, o, s, l) {
        ...
        return 0 > d && (d += nm), d >= i && r >= d || d + nm >= i && r >= d + nm
    }
    ...
    function jr(t, e, n, i, r, a, o, s, l, u) {
        ...
        for (var c, d, f = 0, p = -1, g = 0; h > g; g++) {
            var v = om[g], m = 0 === v || 1 === v ? .5 : 1, y = Sr(t, n, r, o, v);
    ...
    function Zr(t, e, n, i, r, a, o, s) {
        ...
        if (u >= 0 && 1 >= u) {
            for (var h = 0, c = Ar(e, i, a, u), d = 0; l > d; d++) {
                var f = 0 === om[d] || 1 === om[d] ? .5 : 1, p = Ar(t, n, r, om[d]);
                o > p || (h += om[d] < u ? e > c ? f : -f : c > a ? f : -f)
            }
            return h
        }
        var f = 0 === om[0] || 1 === om[0] ? .5 : 1, p = Ar(t, n, r, om[0]);
    ...
    function Kr(t, e, n, i, r, a, o, s) {
        ...
        for (var c = 0, d = 0; 2 > d; d++) {
            ...
            if (f + t > o) {
                ...
                0 > p && (p = rm + p), (p >= i && r >= p || p + rm >= i && r >= p + rm) && (p > Math.PI / 2 && p < 1.5 * Math.PI && (h = -h), c += h)
            }
        }
        return c
    }
    ...
    function ea(t, e, n, i, r, a, o, s, l, u, h) {
        var c = l * (_m / 180), d = ym(c) * (t - n) / 2 + mm(c) * (e - i) / 2,
            f = -1 * mm(c) * (t - n) / 2 + ym(c) * (e - i) / 2, p = d * d / (o * o) + f * f / (s * s);
        p > 1 && (o *= vm(p), s *= vm(p));
        var g = (r === a ? -1 : 1) * vm((o * o * s * s - o * o * f * f - s * s * d * d) / (o * o * f * f + s * s * d * d)) || 0,
            v = g * o * f / s, m = g * -s * d / o, y = (t + n) / 2 + ym(c) * v - mm(c) * m,
            _ = (e + i) / 2 + mm(c) * v + ym(c) * m, x = bm([1, 0], [(d - v) / o, (f - m) / s]),
            w = [(d - v) / o, (f - m) / s], b = [(-1 * d - v) / o, (-1 * f - m) / s], S = bm(w, b);
        wm(w, b) <= -1 && (S = _m), wm(w, b) >= 1 && (S = 0), 0 === a && S > 0 && (S -= 2 * _m), 1 === a && 0 > S && (S += 2 * _m), h.addData(u, y, _, o, s, x, S, c, a)
    }

    function na(t) {
        if (!t) return new tm;
        for (var e, n = 0, i = 0, r = n, a = i, o = new tm, s = tm.CMD, l = t.match(Sm), u = 0; u < l.length; u++) {
    ...
    function Ia(t) {
        ...
        var e = oy.get(t);
        return e || (e = nn(t, -.1), 1e4 > sy && (oy.set(t, e), sy++)), e
    }
    ...
    function Ca(t) {
        ...
        if (e && !t.__highlighted) {
            ...
            if (t.__highlighted = i ? "layer" : "plain", !(t.isGroup || !n && t.useHoverLayer)) {
                var r = t, a = t.style;
                i && (r = n.addHover(t), a = r.style), Ka(a), i || Ta(r), a.extendFrom(e), Da(a, e, "fill"), Da(a, e, "stroke"), Za(a), i || (t.dirty(!1), t.z2 += $m)
            }
        }
    }
    ...
    function ka(t, e, n) {
        var i, r = ty, a = ty;
        t.__highlighted && (r = Jm, i = !0), e(t, n), t.__highlighted && (a = Jm, i = !0), t.isGroup && t.traverse(function (t) {
            !t.isGroup && e(t, n)
    ...
    function Va(t) {
        var e = ny[t];
        return null == e && 32 >= ey && (e = ny[t] = ey++), e
    }
    ...
    function no(t, e, n) {
        return e && !d(e) && (e = Ep.getLocalTransform(e)), n && (e = Fe([], e)), ae([], t, e)
    }
    ...
    function ao(t, e) {
        return p(t, function (t) {
            var n = t[0];
            n = jm(n, e.x), n = Zm(n, e.x + e.width);
            var i = t[1];
            return i = jm(i, e.y), i = Zm(i, e.y + e.height), [n, i]
        })
    }

    function oo(t, e) {
        var n = jm(t.x, e.x), i = Zm(t.x + t.width, e.x + e.width), r = jm(t.y, e.y),
    ...
    function uo(t, e, n, i, r, a, o, s) {
        var l = n - t, u = i - e, h = o - r, c = s - a, d = ho(h, c, l, u);
        if (co(d)) return !1;
    ...
    function Xo(t, e, n) {
        ...
        var i = ko(e), r = n ? "UTC" : "", a = i["get" + r + "FullYear"](), o = i["get" + r + "Month"]() + 1,
    ...
    function Zo(t, e, n) {
        n = xy(n || 0);
        var i = e.width, r = e.height, a = wo(t.left, i), o = wo(t.top, r), s = wo(t.right, i), l = wo(t.bottom, r),
            u = wo(t.width, i), h = wo(t.height, r), c = n[2] + n[0], d = n[1] + n[3], f = t.aspect;
    ...
    function Ko(t, e, n) {
        ...
        var s = n.ignoreSize;
        !x(s) && (s = [s, s]);
        var l = i(Ay[0], 0), u = i(Ay[1], 1);
        o(Ay[0], t, l), o(Ay[1], t, u)
    }
    ...
    function Jo(t) {
        var e = [];
        return f(Oy.getClassesByMainType(t), function (t) {
    ...
    function as(t) {
        var e = t.option, n = e.data, i = I(n) ? Wy : Ny, r = !1, a = e.seriesLayoutBy, o = e.sourceHeader,
            s = e.dimensions, l = ds(t);
        if (l) {
            var u = l.option;
            n = u.source, i = qy(l).sourceFormat, r = !0, a = a || u.seriesLayoutBy, null == o && (o = u.sourceHeader), s = s || u.dimensions
        }
        var h = os(n, i, a, o, s);
        qy(t).source = new es({
            data: n,
    ...
    function os(t, e, n, i, r) {
        ...
        if (e === Fy) "auto" === i || null == i ? ls(function (t) {
            ...
            r[e] = null != t ? t : ""
        }, n, t)), a = r ? r.length : n === Yy ? t.length : t[0] ? t[0].length : null; else if (e === Vy) r || (r = us(t)); else if (e === Hy) r || (r = [], f(t, function (t, e) {
            r.push(e)
        })); else if (e === Ny) {
            var s = er(t[0]);
            a = x(s) && s.length || 1
    ...
    function ls(t, e, n, i) {
        if (null == i && (i = 1 / 0), e === Yy) for (var r = 0; r < n.length && i > r; r++) t(n[r] ? n[r][0] : null, r); else for (var a = n[0] || [], r = 0; r < a.length && i > r; r++) t(a[r], r)
    }
    ...
    function hs(t, e, n) {
        ...
        var a = {}, o = ds(e);
        if (!o || !t) return a;
        var s, l, u = [], h = [], c = e.ecModel, d = qy(c).datasetMap, p = o.uid + "_" + n.seriesLayoutBy;
    ...
    function ms(t) {
        t = t, this.option = {}, this.option[jy] = 1, this._componentsMap = N({series: []}), this._seriesIndices, this._seriesIndicesMap, vs(t, this._theme.option), r(t, Ey, !1), this.mergeOption(t)
    }
    ...
    function Is(t, e, n) {
        ...
        return r || (r = t), r.timeline || (r.timeline = s), Qy([r].concat(a).concat(p(o, function (t) {
            return t.option
        })), function (t) {
            Qy(e, function (e) {
                e(t, n)
    ...
    function ks(t) {
        var e = t && t.itemStyle;
        if (e) for (var n = 0, i = a_.length; i > n; n++) {
            var a = a_[n], o = e.normal, s = e.emphasis;
    ...
    function Os(t, e) {
        var n = r_(t) && t[e], i = r_(n) && n.textStyle;
        if (i) for (var r = 0, a = fv.length; a > r; r++) {
            var e = fv[r];
    ...
    function Es(t) {
        if (r_(t)) {
            ks(t), Ls(t), Os(t, "label"), Os(t, "upperLabel"), Os(t, "edgeLabel"), t.emphasis && (Os(t.emphasis, "label"), Os(t.emphasis, "upperLabel"), Os(t.emphasis, "edgeLabel"));
            var e = t.markPoint;
            e && (ks(e), Bs(e));
            var n = t.markLine;
            n && (ks(n), Bs(n));
            ...
            var n = t.markLine;
            if (n && n.data) for (var l = n.data, o = 0; o < l.length; o++) x(l[o]) ? (Bs(l[o][0]), Bs(l[o][1])) : Bs(l[o]);
    ...
    function Zs(t, e, n) {
        if (t) {
            ...
            if (null != i) {
                ...
                return s && (r = s.name, a = s.index), f_[o](i, e, a, r)
            }
        }
    }
    ...
    function Ks(t, e, n) {
        if (t) {
            ...
            if (i === Ny || i === Vy) {
                ...
                return i !== Ny || S(r) || (r = null), r ? r[n] : void 0
            }
        }
    }
    ...
    function Js(t, e, n, i, r, a) {
        y_.reset(n, i, r, a), t._callingProgress = e, t._callingProgress({
            start: n,
            end: i,
            count: i - n,
            next: y_.next
    ...
    function ul() {
        this.group = new hg, this.uid = vo("viewChart"), this.renderTask = $s({
            plan: dl,
            reset: fl
    ...
    function hl(t, e, n) {
        if (t && (t.trigger(e, n), t.isGroup && !Fa(t))) for (var i = 0, r = t.childCount(); r > i; i++) hl(t.childAt(i), e, n)
    }

    function cl(t, e, n) {
        var i = sr(t, e), r = e && null != e.highlightKey ? Va(e.highlightKey) : null;
    ...
    function fl(t) {
        var e = t.model, n = t.ecModel, i = t.api, r = t.payload, a = e.pipelineContext.progressiveRender, o = t.view,
            s = r && M_(r).updateMethod, l = a ? "incrementalPrepareRender" : s && o[s] ? s : "render";
        return "render" !== l && o[l](e, n, i, r), C_[l]
    }
    ...
    function gl(t, e, n, i) {
        var r = t[e];
        if (r) {
            var a = r[D_] || r, o = r[k_], s = r[A_];
            if (s !== n || o !== i) {
                if (null == n || !i) return t[e] = a;
                r = t[e] = pl(a, n, "debounce" === i), r[D_] = a, r[k_] = i, r[A_] = n
            }
            return r
        }
    }
        ...
        f(e, function (e) {
            if (!r.visualType || r.visualType === e.visualType) {
                ...
                if (u) {
                    ...
                    l.skip = !e.performRawSeries && n.isSeriesFiltered(s.context.model), R_(s, i), o |= s.perform(l)
                })
            }
        }), t.unfinished |= o
    }
    ...
    function yl(t, e, n, i, r) {
        function a(n) {
            var a = n.uid, s = o.get(a) || o.set(a, $s({plan: Ml, reset: Il, count: Cl}));
            s.context = {
                model: n,
                ecModel: i,
                api: r,
    ...
    function _l(t, e, n, i, r) {
        function a(e) {
            ...
            i || (i = s.set(n, $s({reset: wl, onDirty: Sl})), o.dirty()), i.context = {
                model: e,
                overallProgress: h,
                modifyOutputEnd: c
        ...
        var o = n.overallTask = n.overallTask || $s({reset: xl});
    ...
    function zl(t, e, n, i) {
        ...
        }), r.lineDash && (e.style.lineDash = B(r.lineDash).split(Z_)), c[h] && "none" !== c[h] && (e[h] = !0), e.__inheritedStyle = r
    }
    ...
    function Nl(t, e) {
        ...
        if (n) {
            ...
            for (var a = r.length - 1; a > 0; a -= 2) {
                ...
                switch (i = i || Le(), s) {
                    case"translate":
                        o = B(o).split(Z_), ze(i, i, [parseFloat(o[0]), parseFloat(o[1] || 0)]);
                        break;
                    case"scale":
                        o = B(o).split(Z_), Ne(i, i, [parseFloat(o[0]), parseFloat(o[1] || o[0])]);
                        break;
                    case"rotate":
                        o = B(o).split(Z_), Re(i, i, parseFloat(o[0]));
                        break;
                    case"skew":
                        o = B(o).split(Z_), console.warn("Skew transform is not supported yet");
                        break;
                    case"matrix":
                        var o = B(o).split(Z_);
    ...
    function Wl(t, e, n) {
        ...
        n = n || {}, "string" == typeof e && (e = Nx[e]), this.id, this.group, this._dom = t;
        var a = "canvas", o = this._zr = ji(t, {
        ...
        var e = i(e);
        e && u_(e, !0), this._theme = e, this._chartsViews = [], this._chartsMap = {}, this._componentsViews = [], this._componentsMap = {}, this._coordSysMgr = new Ss;
        var s = this._api = su(this);
        Bn(Rx, r), Bn(Bx, r), this._scheduler = new vl(this, s, Bx, Rx), yp.call(this, this._ecEventProcessor = new lu), this._messageCenter = new Gl, this._initEvents(), this.resize = y(this.resize, this), this._pendingActions = [], o.animation.on("frame", this._onframe, this), $l(o, this), E(this)
    }
    ...
    function Yl(t) {
        ...
        n.restorePipelines(e), n.prepareStageTasks(), Ql(t, "component", e, n), Ql(t, "chart", e, n), n.plan()
    }
    ...
    function jl(t, e) {
        var n = t.type, i = t.escapeConnect, r = Lx[n], a = r.actionInfo, l = (a.update || "update").split(":"),
            u = l.pop();
        l = null != l[0] && ux(l[0]), this[Tx] = !0;
        var h = [t], c = !1;
        ...
        ox(h, function (t) {
            d = r.action(t, this._model, this._api), d = d || o({}, t), d.type = a.event || d.type, f.push(d), g ? Ul(this, u, t, "series") : l && Ul(this, u, t, l.main, l.sub)
        }, this), "none" === u || g || l || (this[Cx] ? (Yl(this), kx.update.call(this, t), this[Cx] = !1) : kx[u].call(this, t)), d = c ? {
            type: a.event || n,
            escapeConnect: i,
            batch: f
    ...
    function $l(t, e) {
        t.on("rendered", function () {
            e.trigger("rendered"), !t.animation.isFinished() || e[Cx] || e._scheduler.unfinished || e._pendingActions.length || e.trigger("finished")
        })
    }
    ...
    function Ql(t, e, n, i) {
        function r(t) {
            ...
            if (!r) {
                var h = ux(t.type), c = a ? w_.getClass(h.main, h.sub) : ul.getClass(h.sub);
    ...
    function tu(t, e, n, i) {
        eu(t, e, n, i), ox(t._chartsViews, function (t) {
            t.__alive = !1
        }), nu(t, e, n, i), ox(t._chartsViews, function (t) {
            t.__alive || t.remove(e, n)
        })
    }

    function eu(t, e, n, i, r) {
        ox(r || t._componentsViews, function (t) {
            var r = t.__model;
            t.render(r, e, n, i), ou(r, t)
        })
    }
    ...
    function nu(t, e, n, i, r) {
        ...
        e.eachSeries(function (e) {
            ...
            n.__alive = !0;
            var s = n.renderTask;
            o.updatePayload(s, i), r && r.get(e.uid) && s.dirty(), a |= s.perform(o.getPerformArgs(s)), n.group.silent = !!e.get("silent"), ou(e, n), au(e, n)
        }), o.unfinished |= a, ru(t, e), O_(t._zr.dom, e)
    }
    ...
    function hu(t, e, n) {
        ...
        if (i) return i;
        var r = new Wl(t, e, n);
        return r.id = "ec_" + Gx++, Vx[r.id] = r, cr(t, Xx, r.id), uu(r), r
    }

    function cu(t) {
        if (x(t)) {
            var e = t;
            t = null, ox(e, function (e) {
                null != e.group && (t = e.group)
            }), t = t || "g_" + Wx++, ox(e, function (e) {
                e.group = t
            })
        }
        return Hx[t] = !0, t
    ...
    function fu(t) {
        "string" == typeof t ? t = Vx[t] : t instanceof Wl || (t = pu(t)), t instanceof Wl && !t.isDisposed() && t.dispose()
    }
    ...
    function xu(t, e, n) {
        ...
        var i = lx(t) ? t.type : [t, t = {event: e}][0];
        t.event = (t.event || i).toLowerCase(), e = t.event, ax(Dx.test(i) && Dx.test(e)), Lx[i] || (Lx[i] = {
            action: n,
            actionInfo: t
        }), Ox[e] = i
    }
    ...
    function Eu(t, e, n, i, r) {
        this._old = t, this._new = e, this._oldKeyGetter = n || Bu, this._newKeyGetter = i || Bu, this.context = r
    }
    ...
    function Ru(t) {
        ...
        f(t.dimensions, function (e) {
            ...
            if (l) {
                ...
                Nu(n, l)[u] = e, s.isExtraCoord || (i.set(l, 1), Vu(s.type) && (r[0] = e), Nu(o.encode, l)[u] = s.index), s.defaultTooltip && a.push(e)
            }
            qx.each(function (t, e) {
                var i = Nu(n, e), r = s.otherDims[e];
    ...
    function Xu(t, e) {
        f(nw.concat(e.__wrappedMethods || []), function (n) {
            e.hasOwnProperty(n) && (t[n] = e[n])
        }), t.__wrappedMethods = e.__wrappedMethods, f(iw, function (n) {
            t[n] = i(e[n])
        }), t._calculationInfo = o(e._calculationInfo)
    }

    function Yu(t, e, n, i, r) {
        var a = Qx[e.type], o = i - 1, s = e.name, l = t[s][o];
        if (l && l.length < n) {
    ...
    function Ku(t, e) {
        var n = t._idList[e];
        return null == n && (n = qu(t, t._idDimIdx, e)), null == n && (n = $x + e), n
    }
    ...
    function Qu(t, e) {
        var n = t.dimensions, i = new rw(p(n, t.getDimensionInfo, t), t.hostModel);
        Xu(i, t);
    ...
    function eh(t, e, n) {
        ...
        for (var a = (n.dimsDef || []).slice(), l = N(), u = N(), h = [], c = nh(e, t, a, n.dimCount), d = 0; c > d; d++) {
            var p = a[d] = o({}, S(a[d]) ? a[d] : {name: a[d]}), g = p.name, v = h[d] = new Hu;
        ...
        for (var M = _ || "value", I = 0; c > I; I++) {
            var v = h[I] = h[I] || new Hu, T = v.coordDim;
            null == T && (v.coordDim = ih(M, u, w), v.coordDimIndex = 0, (!_ || 0 >= x) && (v.isExtraCoord = !0), x--), null == v.name && (v.name = ih(v.coordDim, l)), null != v.type || fs(e, I, v.name) !== Uy.Must && (!v.isExtraCoord || null == v.otherDims.itemName && null == v.otherDims.seriesName) || (v.type = "ordinal")
        }
        return h
    }
    ...
    function ah(t) {
        var e = t.get("coordinateSystem"), n = new rh(e), i = lw[e];
    ...
    function hh(t, e, n) {
        ...
        var i, r = e.get("coordinateSystem"), a = Ss.get(r), o = ah(e);
    ...
    function Ih(t) {
        ...
        return f(t, function (t) {
            ...
            var f = wo(t.get("barWidth"), i), p = wo(t.get("barMaxWidth"), i), g = wo(t.get("barMinWidth") || 1, i),
    ...
    function Th(t) {
        ...
        return f(e, function (t, e) {
            n[e] = {};
            var i = t.stacks, r = t.bandWidth, a = wo(t.categoryGap, r), o = wo(t.gap, 1), s = t.remainedWidth,
    ...
    function Dh(t, e) {
        var n = Sh(t, e), i = Ih(n), r = {};
        f(n, function (t) {
            var e = t.getData(), n = t.coordinateSystem, a = n.getBaseAxis(), o = wh(t), s = i[bh(a)][o], l = s.offset,
    ...
    function Bh(t, e, n, i) {
        var r = n.axis.getExtent(), a = r[1] - r[0], o = Ch(i, n.axis);
    ...
    function Eh(t, e) {
        var n = Oh(t, e), i = null != e.getMin(), r = null != e.getMax(), a = e.get("splitNumber");
    ...
    function Nh(t) {
        ...
        return "string" == typeof e ? e = function (e) {
            ...
            return null != n && (r = i - n), e(Fh(t, i), r)
        } : function (e) {
    ...
    function Vh(t) {
        ...
        if (e.get("axisLabel.show") && !n.isBlank()) {
            ...
            var s, l = t.getLabelModel(), u = Nh(t), h = 1;
    ...
    function Hh(t, e) {
        var n = e * Math.PI / 180, i = t.plain(), r = i.width, a = i.height, o = r * Math.cos(n) + a * Math.sin(n),
            s = r * Math.sin(n) + a * Math.cos(n), l = new Tn(i.x, i.y, o, s);
        return l
    }
    ...
    function Yh(t, e, n, i, r, a, o) {
        ...
        var l;
        return l = 0 === t.indexOf("image://") ? _a(t.slice(8), new Tn(e, n, i, r), o ? "center" : "cover") : 0 === t.indexOf("path://") ? ya(t.slice(7), {}, new Tn(e, n, i, r), o ? "center" : "cover") : new Uw({
            shape: {
                symbolType: t,
                x: e,
                y: n,
    ...
    function Kh(t, e, n) {
        ...
        var s = t[0];
        return Zh(r[0], s[0]) && Zh(r[1], s[1]) || (i += Yr(r[0], r[1], s[0], s[1], e, n)), 0 !== i
    }
    ...
    function Qh(t) {
        ...
        for (var n = t.features, i = 0; i < n.length; i++) for (var r = n[i], a = r.geometry, o = a.coordinates, s = a.encodeOffsets, l = 0; l < o.length; l++) {
            var u = o[l];
            if ("Polygon" === a.type) o[l] = Jh(u, s[l], e); else if ("MultiPolygon" === a.type) for (var h = 0; h < u.length; h++) {
                var c = u[h];
                u[h] = Jh(c, s[l][h], e)
            }
        }
    ...
    function ec(t, e) {
        return "category" === t.type ? rc(t, e) : {ticks: t.scale.getTicks()}
    }

    function nc(t) {
        var e = t.getLabelModel(), n = ic(t, e);
        return !e.get("show") || t.scale.isBlank() ? {labels: [], labelCategoryInterval: n.labelCategoryInterval} : n
    }

    function ic(t, e) {
        var n = oc(t, "labels"), i = Gh(e), r = sc(n, i);
        if (r) return r;
        var a, o;
        return w(i) ? a = fc(t, i) : (o = "auto" === i ? uc(t) : i, a = dc(t, o)), lc(n, i, {
            labels: a,
    ...
    function rc(t, e) {
        var n = oc(t, "ticks"), i = Gh(e), r = sc(n, i);
        if (r) return r;
        var a, o;
        if ((!e.get("show") || t.scale.isBlank()) && (a = []), w(i)) a = fc(t, i, !0); else if ("auto" === i) {
            var s = ic(t, t.getLabelModel());
            o = s.labelCategoryInterval, a = p(s.labels, function (t) {
                return t.tickValue
            })
        } else o = i, a = dc(t, o, !0);
        return lc(n, i, {ticks: a, tickCategoryInterval: o})
    }

    function ac(t) {
        var e = t.scale.getTicks(), n = Nh(t);
        return {
    ...
    function hc(t) {
        var e = cc(t), n = Nh(t), i = (e.axisRotate - e.labelRotate) / 180 * Math.PI, r = t.scale, a = r.getExtent(),
            o = r.count();
        ...
        for (var l = a[0], u = t.dataToCoord(l + 1) - t.dataToCoord(l), h = Math.abs(u * Math.cos(i)), c = Math.abs(u * Math.sin(i)), d = 0, f = 0; l <= a[1]; l += s) {
            var p = 0, g = 0, v = Yn(n(l), e.font, "center", "top");
            p = 1.3 * v.width, g = 1.3 * v.height, d = Math.max(d, p, 7), f = Math.max(f, g, 7)
        }
        var m = d / h, y = f / c;
        isNaN(m) && (m = 1 / 0), isNaN(y) && (y = 1 / 0);
        var _ = Math.max(0, Math.floor(Math.min(m, y))), x = $w(t.model), w = t.getExtent(), b = x.lastAutoInterval,
            S = x.lastTickCount;
    ...
    function dc(t, e, n) {
        ...
        var r = Nh(t), a = t.scale, o = a.getExtent(), s = t.getLabelModel(), l = [], u = Math.max((e || 0) + 1, 1),
            h = o[0], c = a.count();
        0 !== h && u > 1 && c / u > 2 && (h = Math.round(Math.ceil(h / u) * u));
        var d = Wh(t), f = s.get("showMinLabel") || d, p = s.get("showMaxLabel") || d;
        f && h !== o[0] && i(o[0]);
    ...
    function wc(t, e, n, i) {
        ...
        if (l) {
            if (null != u) bc(o[u]) && (a = o[u]); else for (var h in o) if (o.hasOwnProperty(h) && bc(o[h]) && !i[r(o[h])]) {
                a = o[h];
                break
            }
            a && (i[r(a)] = !0)
    ...
    function Ac(t, e, n) {
        ...
        a -= u / 2, o -= u / 2, s += u, l += u;
        var h = new Rm({shape: {x: a, y: o, width: s, height: l}});
        return e && (h.shape[r ? "width" : "height"] = 0, to(h, {shape: {width: s, height: l}}, n)), h
    }

    function kc(t, e, n) {
        var i = t.getArea(), r = new Am({
            shape: {
                cx: bo(t.cx, 1),
                cy: bo(t.cy, 1),
                r0: bo(i.r0, 1),
        ...
        return e && (r.shape.endAngle = i.startAngle, to(r, {shape: {endAngle: i.endAngle}}, n)), r
    }
    ...
    function Oc(t, e, n) {
        n.style.text = null, Ja(n, {shape: {width: 0}}, e, t, function () {
            n.parent && n.parent.remove(n)
        })
    }

    function Bc(t, e, n) {
        n.style.text = null, Ja(n, {shape: {r: n.shape.r0}}, e, t, function () {
            n.parent && n.parent.remove(n)
        })
    }
    ...
    function zc(t, e, n, i, r, a, o, l) {
        ...
        l || Cc(t.style, f, i, u, a, n, g), Ec(r) && (f.fill = f.stroke = "none"), Ra(t, f)
    }

    function Rc(t, e) {
        var n = t.get(mb) || 0, i = isNaN(e.width) ? Number.MAX_VALUE : Math.abs(e.width),
    ...
    function Nc(t, e, n) {
        ...
        e.add(f), Vc(f, t, i), f.seriesIndex = t.seriesIndex, t.get("silent") || (f.on("mousedown", Ib), f.on("mousemove", Ib))
    }
    ...
    function Wc(t, e, n) {
        ...
        return new i({shape: Gc(e, n, t), silent: !0, z2: 0})
    }

    function Xc(t, e, n, i) {
        var r, a, o = Do(n - t.rotation), s = i[0] > i[1], l = "start" === e && !s || "start" !== e && s;
    ...
    function Yc(t, e, n) {
        if (!Wh(t.axis)) {
            ...
            var a = e[0], o = e[1], s = e[e.length - 1], l = e[e.length - 2], u = n[0], h = n[1], c = n[n.length - 1],
                d = n[n.length - 2];
            i === !1 ? (Uc(a), Uc(u)) : qc(a, o) && (i ? (Uc(o), Uc(h)) : (Uc(a), Uc(u))), r === !1 ? (Uc(s), Uc(c)) : qc(l, s) && (r ? (Uc(l), Uc(d)) : (Uc(s), Uc(c)))
        }
    }
    ...
    function Kc(t, e, n) {
        ...
        if (r.get("show") && !i.scale.isBlank()) {
            for (var a = r.getModel("lineStyle"), o = n.tickDirection * r.get("length"), l = i.getTicksCoords(), u = Zc(l, t._transform, o, s(a.getLineStyle(), {stroke: e.get("axisLine.lineStyle.color")}), "ticks"), h = 0; h < u.length; h++) t.group.add(u[h]);
            return u
        }
    }
    ...
    function $c(t, e, n) {
        ...
        if (r.get("show") && !i.scale.isBlank()) {
            ...
            if (a.length) for (var o = r.getModel("lineStyle"), l = n.tickDirection * r.get("length"), u = s(o.getLineStyle(), s(e.getModel("axisTick").getLineStyle(), {stroke: e.get("axisLine.lineStyle.color")})), h = 0; h < a.length; h++) for (var c = Zc(a[h], t._transform, l, u, "minorticks_" + h), d = 0; d < c.length; d++) t.group.add(c[d])
        }
    }
    ...
    function Qc(t, e, n) {
        ...
        if (r && !i.scale.isBlank()) {
            var a = e.getModel("axisLabel"), o = a.get("margin"), s = i.getViewLabels(),
                l = (D(n.labelRotate, a.get("rotate")) || 0) * Tb / 180, u = kb(n.rotation, l, n.labelDirection),
                h = e.getCategories && e.getCategories(!0), c = [], d = Pb(e), p = e.get("triggerEvent");
            return f(s, function (r, s) {
                ...
                var m = v.getTextColor() || e.get("axisLine.lineStyle.color"), y = i.dataToCoord(l),
                    ...
                    x = new Im({anid: "label_" + l, position: _, rotation: u.rotation, silent: d, z2: 10});
                Wa(x.style, v, {
                    text: f,
                ...
                }), p && (x.eventData = Ab(e), x.eventData.targetType = "axisLabel", x.eventData.value = g), t._dumbGroup.add(x), x.updateTransform(), c.push(x), t.group.add(x), x.decomposeTransform()
            }), c
        }
    }
    ...
    function Jc(t, e) {
        ...
        return td(n, t, e), n.seriesInvolved && nd(n, t), n
    }

    function td(t, e, n) {
        var i = e.getComponent("tooltip"), r = e.getComponent("axisPointer"), a = r.get("link", !0) || [], o = [];
        Lb(n.getCoordinateSystems(), function (n) {
            function s(i, s, l) {
                var h = l.model.getModel("axisPointer", r), d = h.get("show");
                if (d && ("auto" !== d || i || ld(h))) {
                    null == s && (s = h.get("triggerTooltip")), h = i ? ed(l, c, r, e, i, s) : h;
                    var f = h.get("snap"), p = ud(l.model), g = s || f || "category" === l.type, v = t.axesInfo[p] = {
                        key: p,
                        axis: l,
                        coordSys: n,
                        axisPointerModel: h,
            ...
            if (n.axisPointerEnabled) {
                var l = ud(n.model), u = t.coordSysAxesInfo[l] = {};
                t.coordSysMap[l] = n;
                ...
                if (Lb(n.getAxes(), Ob(s, !1, null)), n.getTooltipAxes && i && c.get("show")) {
                    ...
                    (d || f) && Lb(p.baseAxes, Ob(s, f ? "cross" : !0, d)), f && Lb(p.otherAxes, Ob(s, "cross", !1))
                }
            }
        })
    }
    ...
    function ed(t, e, n, r, a, o) {
        ...
        Lb(["type", "snap", "lineStyle", "shadowStyle", "label", "animation", "animationDurationUpdate", "animationEasingUpdate", "z"], function (t) {
            u[t] = i(l.get(t))
    ...
    function nd(t, e) {
        e.eachSeries(function (e) {
            ...
            n && "none" !== i && i !== !1 && "item" !== i && r !== !1 && e.get("axisPointer.show", !0) !== !1 && Lb(t.coordSysAxesInfo[ud(n.model)], function (t) {
                var i = t.axis;
    ...
    function fd(t, e, n, i) {
        var r = n.axis;
        if (!r.scale.isBlank()) {
            var a = n.getModel("splitArea"), o = a.getModel("areaStyle"), l = o.get("color"),
                u = i.coordinateSystem.getRect(), h = r.getTicksCoords({tickModel: a, clamp: !0});
            if (h.length) {
    ...
    function gd(t, e, n) {
        hg.call(this), this.updateData(t, e, n)
    }
    ...
    function _d(t) {
        this.group = new hg, this._symbolCtor = t || gd
    }
    ...
    function Sd(t, e, n) {
        var i, r = t.getBaseAxis(), a = t.getOtherAxis(r), o = Md(a, n), s = r.dim, l = a.dim, u = e.mapDimension(l),
    ...
    function Ad(t, e, n, i, r, a, o, s, l, u, h) {
        for (var c = 0, d = n, f = 0; i > f; f++) {
            ...
            if (d === n) t[a > 0 ? "moveTo" : "lineTo"](p[0], p[1]); else if (l > 0) {
                ...
                Kb(Qb, g), Qb[v] = g[v] + m, Kb(Jb, p), Jb[v] = p[v] - m, t.bezierCurveTo(Qb[0], Qb[1], Jb[0], Jb[1], p[0], p[1])
    ...
    function kd(t, e, n, i, r, a, o, s, l, u, h) {
        for (var c = 0, d = n, f = 0; i > f; f++) {
            ...
            if (d === n) t[a > 0 ? "moveTo" : "lineTo"](p[0], p[1]), Kb(Qb, p); else if (l > 0) {
                var g = d + a, v = e[g];
                if (h) for (; v && Cd(e[g]);) g += a, v = e[g];
                var m = .5, y = e[c], v = e[g];
                if (!v || Cd(v)) Kb(Jb, p); else {
                    Cd(v) && !h && (v = p), q($b, v, y);
                    var _, x;
                    if ("x" === u || "y" === u) {
                        var w = "x" === u ? 0 : 1;
                        _ = Math.abs(p[w] - y[w]), x = Math.abs(p[w] - v[w])
                    } else _ = pp(p, y), x = pp(p, v);
                    m = x / (x + _), Zb(Jb, p, $b, -l * (1 - m))
                }
                qb(Qb, Qb, s), jb(Qb, Qb, o), qb(Jb, Jb, s), jb(Jb, Jb, o), t.bezierCurveTo(Qb[0], Qb[1], Jb[0], Jb[1], p[0], p[1]), Zb(Qb, p, $b, l * m)
            } else t.lineTo(p[0], p[1]);
            c = d, d += a
        }
        return f
    ...
    function Fd(t, e, n) {
        if ("cartesian2d" === t.type) {
            var i = t.getBaseAxis().isHorizontal(), r = Ac(t, e, n);
            if (!n.get("clip", !0)) {
    ...
    function Wd(t, e) {
        hg.call(this);
        var n = new Am({z2: 2}), i = new Bm, r = new Im;
    ...
    function Yd(t, e, n, i, r, a, o, s) {
        ...
        Xd(u, e, n, i, 1, r, a, o, s, c), Xd(l, e, n, i, -1, r, a, o, s, h);
    ...
    function Zd(t, e) {
        var n = xy(e.get("padding")), i = e.getItemStyle(["color", "opacity"]);
    ...
    function $d(t, e, n, i) {
        Jd(t, e, n, i), n.dispatchAction({type: "legendToggleSelect", name: null != t ? t : e}), Qd(t, e, n, i)
    }
    ...
    function tf(t, e, n) {
        ...
        r[i.index] = 0, Ko(e, n, {type: "box", ignoreSize: r})
    }
    ...
    function ef(t, e, n, i, r) {
        ...
        if (!a.scale.isBlank() && a.containData(e)) {
            ...
            var s = nf(e, t), l = s.payloadBatch, u = s.snapToValue;
    ...
    function nf(t, e) {
        ...
        return OS(e.seriesModels, function (e) {
            ...
            if (null != l && isFinite(l)) {
                ...
                o >= f && ((o > f || d >= 0 && 0 > s) && (o = f, s = d, r = l, a.length = 0), OS(u, function (t) {
    ...
    function af(t, e, n, i) {
        ...
        if (e.triggerTooltip && r.length) {
            var l = e.coordSys.model, u = ud(l), h = t.map[u];
            h || (h = t.map[u] = {
                coordSysId: l.id,
    ...
    function lf(t, e, n) {
        var i = n.getZr(), r = "axisPointerLastHighlights", a = ES(i)[r] || {}, o = ES(i)[r] = {};
        OS(t, function (t) {
            var e = t.axisPointerModel.option;
            "show" === e.status && OS(e.seriesDataIndices, function (t) {
    ...
    function df(t, e, n) {
        if (!Kf.node) {
            var i = e.getZr();
            RS(i).records || (RS(i).records = {}), ff(i, e);
    ...
    function yf(t, e) {
        if (!Kf.node) {
            var n = e.getZr(), i = (RS(n).records || {})[t];
    ...
    function Tf(t, e, n, i, r) {
        var a = n.get("value"), o = Df(a, e.axis, e.ecModel, n.get("seriesDataIndices"), {
                precision: n.get("label.precision"),
                formatter: n.get("label.formatter")
            }), s = n.getModel("label"), l = xy(s.get("padding") || 0), u = s.getFont(), h = Yn(o, u), c = r.position,
            d = h.width + l[1] + l[3], f = h.height + l[0] + l[2], p = r.align;
        "right" === p && (c[0] -= d), "center" === p && (c[0] -= d / 2);
        var g = r.verticalAlign;
        "bottom" === g && (c[1] -= f), "middle" === g && (c[1] -= f / 2), Cf(c, d, f, i);
    ...
    function Df(t, e, n, i, r) {
        ...
        if (o) {
            var s = {value: Fh(e, t), axisDimension: e.dim, axisIndex: e.index, seriesData: []};
            f(i, function (t) {
    ...
    function kf(t, e, n, i, r, a) {
        ...
        n.labelMargin = r.get("label.margin"), Tf(e, i, r, a, {
    ...
    function zf(t) {
        ...
        return i && e.push("color:" + i), e.push("font:" + t.getFont()), n && e.push("line-height:" + Math.round(3 * n / 2) + "px"), YS(["decoration", "align"], function (n) {
            var i = t.get(n);
            i && e.push("text-" + n + ":" + i)
        }), e.join(";")
    }
    ...
    function Rf(t) {
        var e = [], n = t.get("transitionDuration"), i = t.get("backgroundColor"), r = t.getModel("textStyle"),
            a = t.get("padding");
        return n && e.push(Ef(n)), i && (Kf.canvasSupported ? e.push("background-Color:" + i) : (e.push("background-Color:#" + rn(i)), e.push("filter:alpha(opacity=70)"))), YS(["width", "color", "radius"], function (n) {
            var i = "border-" + n, r = US(i), a = t.get(r);
            null != a && e.push(i + ":" + a + ("color" === n ? "" : "px"))
        }), e.push(zf(r)), null != a && e.push("padding:" + xy(a).join("px ") + "px"), e.join(";") + ";"
    }
    ...
    function Ff(t, e, n) {
        ...
        var r = this._zr = e.getZr(), a = this._appendToBody = n && n.appendToBody;
        this._styleCoord = [0, 0], Nf(this._styleCoord, r, a, e.getWidth() / 2, e.getHeight() / 2), a ? document.body.appendChild(i) : t.appendChild(i), this._container = t, this._show = !1, this._hideTimeout;
        var o = this;
    ...
    var Kf = Zf, $f = {
        ...
        }, Jf = Object.prototype.toString, tp = Array.prototype, ep = tp.forEach, np = tp.filter, ip = tp.slice,
        rp = tp.map, ap = tp.reduce, op = {}, sp = function () {
    ...
    var hp = (Object.freeze || Object)({
            ...
            concatArray: F,
            noop: V
        }), cp = "undefined" == typeof Float32Array ? Array : Float32Array, dp = j, fp = Z, pp = ee, gp = ne,
    ...
    var mp = Array.prototype.slice, yp = function (t) {
        this._$handlers = {}, this._$eventProcessor = t
    };
    yp.prototype = {
        constructor: yp, one: function (t, e, n, i) {
    ...
    var _p = Math.log(2), xp = "___zrEVENTSAVED", wp = [],
        bp = "undefined" != typeof window && !!window.addEventListener,
        Sp = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Mp = [], Ip = bp ? function (t) {
    ...
    Tp.prototype = {
        constructor: Tp, recognize: function (t, e, n) {
    ...
    var Ap = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"],
        kp = function (t, e, n, i) {
            yp.call(this), this.storage = t, this.painter = e, this.painterRoot = i, n = n || new Ae, this.proxy = null, this._hovered = {}, this._lastTouchMoment, this._lastX, this._lastY, this._gestureMgr, le.call(this), this.setHandlerProxy(n)
        };
    kp.prototype = {
        constructor: kp, setHandlerProxy: function (t) {
            this.proxy && this.proxy.dispose(), t && (f(Ap, function (e) {
                t.on && t.on(e, this[e], this)
            }, this), t.handler = this), this.proxy = t
        }, mousemove: function (t) {
            var e = t.zrX, n = t.zrY, i = Pe(this, e, n), r = this._hovered, a = r.target;
        ...
        kp.prototype[t] = function (e) {
            var n, i, r = e.zrX, a = e.zrY, o = Pe(this, r, a);
    ...
    var Pp = "undefined" == typeof Float32Array ? Array : Float32Array, Lp = (Object.freeze || Object)({
        create: Le,
        identity: Oe,
        copy: Be,
        mul: Ee,
        ...
        invert: Fe,
        clone: Ve
    }), Op = Oe, Bp = 5e-5, Ep = function (t) {
        t = t || {}, t.position || (this.position = [0, 0]), null == t.rotation && (this.rotation = 0), t.scale || (this.scale = [1, 1]), this.origin = this.origin || null
    }, zp = Ep.prototype;
    zp.transform = null, zp.needLocalTransform = function () {
    ...
    zp.updateTransform = function () {
        ...
        i = i || Le(), n ? this.getLocalTransform(i) : Op(i), e && (n ? Ee(i, t.transform, i) : Be(i, t.transform)), this.transform = i;
        var r = this.globalScaleRatio;
        if (null != r && 1 !== r) {
            this.getGlobalScale(Rp);
            var a = Rp[0] < 0 ? -1 : 1, o = Rp[1] < 0 ? -1 : 1, s = ((Rp[0] - a) * r + a) / Rp[0] || 0,
                l = ((Rp[1] - o) * r + o) / Rp[1] || 0;
    ...
    zp.setLocalTransform = function (t) {
        ...
        if (this.transform) {
            ...
            var n = this.origin;
            n && (n[0] || n[1]) && (Fp[4] = n[0], Fp[5] = n[1], Ee(Np, e, Fp), Np[4] -= n[0], Np[5] -= n[1], e = Np), this.setLocalTransform(e)
        }
    ...
    Ge.prototype = {
        constructor: Ge, step: function (t, e) {
            ...
            if (!(0 > n)) {
                n = Math.min(n, 1);
                var i = this.easing, r = "string" == typeof i ? Vp[i] : i, a = "function" == typeof r ? r(n) : n;
    ...
    var Wp = function (t) {
        ...
        this._list = new Hp, this._map = {}, this._maxSize = t || 10, this._lastRemovedEntry = null
    }, Yp = Xp.prototype;
    Yp.put = function (t, e) {
        ...
        if (null == i[t]) {
            ...
            o ? o.value = e : o = new Wp(e), o.key = t, n.insertEntry(o), i[t] = o
        }
        return r
    }, Yp.get = function (t) {
    ...
    var Up = {
    ...
    }, qp = new Xp(20), jp = null, Zp = an, Kp = on, $p = (Object.freeze || Object)({
        parse: Je,
        lift: nn,
        toHex: rn,
        fastLerp: an,
        ...
        modifyAlpha: ln,
        stringify: un
    }), Qp = Array.prototype.slice, Jp = function (t, e, n, i) {
    ...
    var eg = 0, ng = tg, ig = function () {
    };
    1 === eg && (ig = console.error);
    var rg = ig, ag = function () {
        this.animators = []
    };
    ag.prototype = {
        constructor: ag, animate: function (t, e) {
            ...
            var c = r.animators, d = new Jp(n, e);
    ...
    var og = function (t) {
        Ep.call(this, t), yp.call(this, t), ag.call(this, t), this.id = t.id || jf()
    };
    og.prototype = {
    ...
    }, c(og, ag), c(og, Ep), c(og, yp);
    var sg = ae, lg = Math.min, ug = Math.max;
    Tn.prototype = {
        constructor: Tn, union: function (t) {
            var e = lg(t.x, this.x), n = lg(t.y, this.y);
            this.width = ug(t.x + t.width, this.x + this.width) - e, this.height = ug(t.y + t.height, this.y + this.height) - n, this.x = e, this.y = n
        }, applyTransform: function () {
            var t = [], e = [], n = [], i = [];
            return function (r) {
                if (r) {
                    t[0] = n[0] = this.x, t[1] = i[1] = this.y, e[0] = i[0] = this.x + this.width, e[1] = n[1] = this.y + this.height, sg(t, t, r), sg(e, e, r), sg(n, n, r), sg(i, i, r), this.x = lg(t[0], e[0], n[0], i[0]), this.y = lg(t[1], e[1], n[1], i[1]);
                    var a = ug(t[0], e[0], n[0], i[0]), o = ug(t[1], e[1], n[1], i[1]);
                    this.width = a - this.x, this.height = o - this.y
                }
            }
        }(), calculateTransform: function (t) {
            var e = this, n = t.width / e.width, i = t.height / e.height, r = Le();
    ...
    hg.prototype = {
        constructor: hg, isGroup: !0, type: "group", silent: !1, children: function () {
            ...
            e && e !== t.__storage && (e.addToStorage(t), t instanceof hg && t.addChildrenToStorage(e)), n && n.refresh()
        }, remove: function (t) {
            ...
            for (e = 0; e < n.length; e++) t = n[e], i && (i.delFromStorage(t), t instanceof hg && t.delChildrenFromStorage(i)), t.parent = null;
            ...
            for (var e = 0; e < this._children.length; e++) {
                ...
                t.addToStorage(n), n instanceof hg && n.addChildrenToStorage(t)
            }
        }, delChildrenFromStorage: function (t) {
            for (var e = 0; e < this._children.length; e++) {
                var n = this._children[e];
                t.delFromStorage(n), n instanceof hg && n.delChildrenFromStorage(t)
            }
        }, dirty: function () {
    ...
    var cg = 32, dg = 7, fg = function () {
        this._roots = [], this._displayList = [], this._displayListLen = 0
    };
    fg.prototype = {
        constructor: fg, traverse: function (t, e) {
            ...
            n.length = this._displayListLen, Kf.canvasSupported && Bn(n, En)
    ...
    var pg = {
        ...
        }, vg = {NONE: 0, STYLE_BIND: 1, PLAIN_TEXT: 2}, mg = 9,
    ...
    _g.prototype = {
        ...
        blend: null,
        bind: function (t, e, n) {
            var i = this, r = n && n.style, a = !r || t.__attrCachedBy !== vg.STYLE_BIND;
            t.__attrCachedBy = vg.STYLE_BIND;
            for (var o = 0; o < yg.length; o++) {
                var s = yg[o], l = s[0];
                (a || i[l] !== r[l]) && (t[l] = gg(t, l, i[l] || s[1]))
            }
    ...
    for (var xg = _g.prototype, wg = 0; wg < yg.length; wg++) {
        var bg = yg[wg];
    ...
    var Mg = function (t, e, n) {
        var i;
        n = n || ng, "string" == typeof t ? i = Fn(t, e, n) : S(t) && (i = t, t = i.id), this.id = t, this.dom = i;
        var r = i.style;
        ...
        clear: function (t, e) {
            ...
            if (o && (this.domBack || this.createBackBuffer(), this.ctxBack.globalCompositeOperation = "copy", this.ctxBack.drawImage(n, 0, 0, r / l, a / l)), i.clearRect(0, 0, r, a), e && "transparent" !== e) {
                ...
                e.colorStops ? (u = e.__canvasGradient || _g.getGradient(i, e, {
                    ...
                    width: r,
                    height: a
                }), e.__canvasGradient = u) : e.image && (u = Sg.prototype.getCanvasPattern.call(e, i)), i.save(), i.fillStyle = u || e, i.fillRect(0, 0, r, a), i.restore()
            }
            if (o) {
                var h = this.domBack;
    ...
    var Ig = "undefined" != typeof window && (window.requestAnimationFrame && window.requestAnimationFrame.bind(window) || window.msRequestAnimationFrame && window.msRequestAnimationFrame.bind(window) || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame) || function (t) {
            setTimeout(t, 16)
        }, Tg = new Xp(50), Cg = {}, Dg = 0, Ag = 5e3, kg = /\{([a-zA-Z0-9_]+)\|([^}]*)\}/g, Pg = "12px sans-serif",
        Lg = {};
    Lg.measureText = function (t, e) {
        var n = l();
        return n.font = e || Pg, n.measureText(t)
    };
    var Og = Pg, Bg = {left: 1, right: 1, center: 1}, Eg = {top: 1, bottom: 1, middle: 1},
        ...
        Rg = {}, Ng = {}, Fg = new Tn, Vg = function () {
        };
    Vg.prototype = {
        constructor: Vg, drawRectText: function (t, e) {
            var n = this.style;
            ...
            if (null != i && (i += ""), Ii(i, n)) {
                ...
                n.transformText ? this.setTransform(t) : r && (Fg.copy(e), Fg.applyTransform(r), e = Fg), hi(this, t, i, n, e, mg), t.restore()
            }
        }
    }, Ti.prototype = {
        constructor: Ti,
        ...
        useStyle: function (t) {
            return this.style = new _g(t, this), this.dirty(!1), this
        },
        calculateTextPosition: null
    }, h(Ti, og), c(Ti, Vg), Ci.prototype = {
        constructor: Ci, type: "image", brush: function (t, e) {
    ...
    var Hg = 1e5, Gg = 314159, Wg = .01, Xg = .001, Yg = new Tn(0, 0, 0, 0), Ug = new Tn(0, 0, 0, 0),
        qg = function (t, e, n) {
            this.type = "canvas";
            var i = !t.nodeName || "CANVAS" === t.nodeName.toUpperCase();
            this._opts = n = o({}, n || {}), this.dpr = n.devicePixelRatio || ng, this._singleCanvas = i, this.root = t;
            var r = t.style;
            ...
            if (this._layerConfig = {}, this._needsManuallyCompositing = !1, i) {
                ...
                h.__builtin__ = !0, h.initContext(), s[Gg] = h, h.zlevel = Gg, a.push(Gg), this._domRoot = t
            } else {
    ...
    qg.prototype = {
        constructor: qg, getType: function () {
            ...
            if (n && n.clear(), e) {
                Bn(t, this.storage.displayableSortFunc), n || (n = this._hoverlayer = this.getLayer(Hg));
                var i = {};
                n.ctx.save();
                for (var r = 0; e > r;) {
            ...
            var t = this.getLayer(Gg).ctx, e = this._domRoot.width, n = this._domRoot.height;
            ...
            return Kf.wxa && f(this._layers, function (t) {
            ...
            return n || (n = new Mg("zr_" + t, this, this.dpr), n.zlevel = t, n.__builtin__ = !0, this._layerConfig[t] && r(n, this._layerConfig[t], !0), e && (n.virtual = e), this.insertLayer(t, n), n.initContext()), n
            ...
            for (var r = null, a = 0, n = 0; n < t.length; n++) {
                ...
                i.incremental ? (o = this.getLayer(s + Xg, this._needsManuallyCompositing), o.incremental = !0, a = 1) : o = this.getLayer(s + (a > 0 ? Wg : 0), this._needsManuallyCompositing), o.__builtin__ || rg("ZLevel " + s + " has been used by unkown layer " + o.id), o !== r && (o.__used = !0, o.__startIndex !== n && (o.__dirty = !0), o.__startIndex = n, o.__drawIndex = o.incremental ? -1 : n, e(n), r = o), i.__dirty && (o.__dirty = !0, o.incremental && o.__drawIndex < 0 && (o.__drawIndex = n))
            }
            ...
            if (this._domRoot.style) {
                ...
                this._width = t, this._height = e, this.getLayer(Gg).resize(t, e)
            }
            return this
            ...
            if (t = t || {}, this._singleCanvas && !this._compositeManually) return this._layers[Gg].dom;
            ...
            var m = Ci, y = new m({style: {x: 0, y: 0, image: n}});
    ...
    var jg = function (t) {
        ...
        }, this._clips = [], this._running = !1, this._time, this._pausedTime, this._pauseStart, this._paused = !1, yp.call(this)
    };
    jg.prototype = {
    ...
    var Zg = 300, Kg = Kf.domSupported, $g = function () {
    ...
    }(), Qg = {mouse: ["mousemove", "mouseup"], pointer: ["pointermove", "pointerup"]}, Jg = Vi.prototype;
    ...
    var tv = {
        mousedown: function (t) {
            ...
            t = be(this.dom, t), Ri(t), this._lastTouchMoment = new Date, this.handler.processGesture(t, "start"), tv.mousemove.call(this, t), tv.mousedown.call(this, t)
        }, touchmove: function (t) {
            t = be(this.dom, t), Ri(t), this.handler.processGesture(t, "change"), tv.mousemove.call(this, t)
        }, touchend: function (t) {
            t = be(this.dom, t), Ri(t), this.handler.processGesture(t, "end"), tv.mouseup.call(this, t), +new Date - this._lastTouchMoment < Zg && tv.click.call(this, t)
    ...
    nv.dispose = function () {
        Xi(this._localHandlerScope), Kg && Xi(this._globalHandlerScope)
    }, nv.setCursor = function (t) {
        this.dom.style && (this.dom.style.cursor = t || "default")
    }, c(qi, yp);
    var iv = !Kf.canvasSupported, rv = {canvas: qg}, av = {}, ov = "4.3.0", sv = function (t, e, n) {
        n = n || {}, this.dom = e, this.id = t;
        var i = this, r = new fg, a = n.renderer;
        if (iv) {
        ...
        this.handler = new kp(r, o, s, o.root), this.animation = new jg({stage: {update: y(this.flush, this)}}), this.animation.start(), this._needsRefresh;
    ...
    var lv = (Object.freeze || Object)({version: ov, init: ji, dispose: Zi, getInstance: Ki, registerPainter: $i}),
        uv = f, hv = S, cv = x, dv = "series\x00",
        ...
        pv = 0, gv = ".", vv = "___EC__COMPONENT__CONTAINER___", mv = 0, yv = function (t) {
        ...
        }, Sv = Math.pow, Mv = Math.sqrt, Iv = 1e-8, Tv = 1e-4, Cv = Mv(3), Dv = 1 / 3, Av = H(), kv = H(), Pv = H(),
        Lv = Math.min, Ov = Math.max, Bv = Math.sin, Ev = Math.cos, zv = 2 * Math.PI, Rv = H(), Nv = H(), Fv = H(),
        Vv = [], Hv = [], Gv = {M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7}, Wv = [], Xv = [], Yv = [], Uv = [],
        qv = Math.min, jv = Math.max, Zv = Math.cos, Kv = Math.sin, $v = Math.sqrt, Qv = Math.abs,
        Jv = "undefined" != typeof Float32Array, tm = function (t) {
    ...
    tm.prototype = {
        ...
        setScale: function (t, e, n) {
            n = n || 0, this._ux = Qv(n / ng / t) || 0, this._uy = Qv(n / ng / e) || 0
        },
        getContext: function () {
            return this._ctx
        },
        ...
        moveTo: function (t, e) {
            return this.addData(Gv.M, t, e), this._ctx && this._ctx.moveTo(t, e), this._x0 = t, this._y0 = e, this._xi = t, this._yi = e, this
        },
        lineTo: function (t, e) {
            var n = Qv(t - this._xi) > this._ux || Qv(e - this._yi) > this._uy || this._len < 5;
            return this.addData(Gv.L, t, e), this._ctx && n && (this._needsDash() ? this._dashedLineTo(t, e) : this._ctx.lineTo(t, e)), n && (this._xi = t, this._yi = e), this
        },
        bezierCurveTo: function (t, e, n, i, r, a) {
            return this.addData(Gv.C, t, e, n, i, r, a), this._ctx && (this._needsDash() ? this._dashedBezierTo(t, e, n, i, r, a) : this._ctx.bezierCurveTo(t, e, n, i, r, a)), this._xi = r, this._yi = a, this
        },
        quadraticCurveTo: function (t, e, n, i) {
            return this.addData(Gv.Q, t, e, n, i), this._ctx && (this._needsDash() ? this._dashedQuadraticTo(t, e, n, i) : this._ctx.quadraticCurveTo(t, e, n, i)), this._xi = n, this._yi = i, this
        },
        arc: function (t, e, n, i, r, a) {
            return this.addData(Gv.A, t, e, n, n, i, r - i, 0, a ? 0 : 1), this._ctx && this._ctx.arc(t, e, n, i, r, a), this._xi = Zv(r) * n + t, this._yi = Kv(r) * n + e, this
        },
        arcTo: function (t, e, n, i, r) {
            return this._ctx && this._ctx.arcTo(t, e, n, i, r), this
        },
        rect: function (t, e, n, i) {
            return this._ctx && this._ctx.rect(t, e, n, i), this.addData(Gv.R, t, e, n, i), this
        },
        closePath: function () {
            this.addData(Gv.Z);
        ...
        _dashedLineTo: function (t, e) {
            var n, i, r = this._dashSum, a = this._dashOffset, o = this._lineDash, s = this._ctx, l = this._xi,
                u = this._yi, h = t - l, c = e - u, d = $v(h * h + c * c), f = l, p = u, g = o.length;
            for (h /= d, c /= d, 0 > a && (a = r + a), a %= r, f -= a * h, p -= a * c; h > 0 && t >= f || 0 > h && f >= t || 0 === h && (c > 0 && e >= p || 0 > c && p >= e);) i = this._dashIdx, n = o[i], f += h * n, p += c * n, this._dashIdx = (i + 1) % g, h > 0 && l > f || 0 > h && f > l || c > 0 && u > p || 0 > c && p > u || s[i % 2 ? "moveTo" : "lineTo"](h >= 0 ? qv(f, t) : jv(f, t), c >= 0 ? qv(p, e) : jv(p, e));
            h = f - t, c = p - e, this._dashOffset = -$v(h * h + c * c)
        },
        _dashedBezierTo: function (t, e, n, i, r, a) {
            ...
            for (0 > d && (d = c + d), d %= c, o = 0; 1 > o; o += .1) s = m(g, t, n, r, o + .1) - m(g, t, n, r, o), l = m(v, e, i, a, o + .1) - m(v, e, i, a, o), y += $v(s * s + l * l);
            for (; x > _ && (w += f[_], !(w > d)); _++) ;
            for (o = (w - d) / y; 1 >= o;) u = m(g, t, n, r, o), h = m(v, e, i, a, o), _ % 2 ? p.moveTo(u, h) : p.lineTo(u, h), o += f[_] / y, _ = (_ + 1) % x;
            _ % 2 !== 0 && p.lineTo(r, a), s = r - u, l = a - h, this._dashOffset = -$v(s * s + l * l)
        },
        ...
        getBoundingRect: function () {
            Wv[0] = Wv[1] = Yv[0] = Yv[1] = Number.MAX_VALUE, Xv[0] = Xv[1] = Uv[0] = Uv[1] = -Number.MAX_VALUE;
            for (var t = this.data, e = 0, n = 0, i = 0, r = 0, a = 0; a < t.length;) {
                var o = t[a++];
                switch (1 === a && (e = t[a], n = t[a + 1], i = e, r = n), o) {
                    case Gv.M:
                        i = t[a++], r = t[a++], e = i, n = r, Yv[0] = i, Yv[1] = r, Uv[0] = i, Uv[1] = r;
                        break;
                    case Gv.L:
                        zr(e, n, t[a], t[a + 1], Yv, Uv), e = t[a++], n = t[a++];
                        break;
                    case Gv.C:
                        Rr(e, n, t[a++], t[a++], t[a++], t[a++], t[a], t[a + 1], Yv, Uv), e = t[a++], n = t[a++];
                        break;
                    case Gv.Q:
                        Nr(e, n, t[a++], t[a++], t[a], t[a + 1], Yv, Uv), e = t[a++], n = t[a++];
                        break;
                    case Gv.A:
                        var s = t[a++], l = t[a++], u = t[a++], h = t[a++], c = t[a++], d = t[a++] + c;
                        a += 1;
                        var f = 1 - t[a++];
                        1 === a && (i = Zv(c) * u + s, r = Kv(c) * h + l), Fr(s, l, u, h, c, d, f, Yv, Uv), e = Zv(d) * u + s, n = Kv(d) * h + l;
                        break;
                    case Gv.R:
                        i = e = t[a++], r = n = t[a++];
                        var p = t[a++], g = t[a++];
                ...
                oe(Wv, Wv, Yv), se(Xv, Xv, Uv)
            }
            return 0 === a && (Wv[0] = Wv[1] = Xv[0] = Xv[1] = 0), new Tn(Wv[0], Wv[1], Xv[0] - Wv[0], Xv[1] - Wv[1])
        },
            ...
            for (var e, n, i, r, a, o, s = this.data, l = this._ux, u = this._uy, h = this._len, c = 0; h > c;) {
                ...
                switch (1 === c && (i = s[c], r = s[c + 1], e = i, n = r), d) {
                    case Gv.M:
                        ...
                        break;
                    case Gv.L:
                        a = s[c++], o = s[c++], (Qv(a - i) > l || Qv(o - r) > u || c === h - 1) && (t.lineTo(a, o), i = a, r = o);
                        break;
                    case Gv.C:
                    ...
                    case Gv.A:
                        ...
                        M ? (t.translate(f, p), t.rotate(_), t.scale(b, S), t.arc(0, 0, w, m, I, 1 - x), t.scale(1 / b, 1 / S), t.rotate(-_), t.translate(-f, -p)) : t.arc(f, p, w, m, I, 1 - x), 1 === c && (e = Zv(m) * g + f, n = Kv(m) * v + p), i = Zv(I) * g + f, r = Kv(I) * v + p;
                        break;
                    case Gv.R:
    ...
    var em = 2 * Math.PI, nm = 2 * Math.PI, im = tm.CMD, rm = 2 * Math.PI, am = 1e-4, om = [-1, -1, -1], sm = [-1, -1],
        lm = Sg.prototype.getCanvasPattern, um = Math.abs, hm = new tm(!0);
    ta.prototype = {
        constructor: ta,
        type: "path",
        __dirtyPath: !0,
        ...
        subPixelOptimize: !1,
        brush: function (t, e) {
            var n = this.style, i = this.path || hm, r = n.hasStroke(), a = n.hasFill(), o = n.fill, s = n.stroke,
            ...
            l ? t.fillStyle = this._fillGradient : h && (t.fillStyle = lm.call(o, t)), u ? t.strokeStyle = this._strokeGradient : c && (t.strokeStyle = lm.call(s, t));
        ...
        getBoundingRect: function () {
            ...
            if (n) {
                var i = this.path;
                i || (i = this.path = new tm), this.__dirtyPath && (i.beginPath(), this.buildPath(i, this.shape, !1)), t = i.getBoundingRect()
            }
    ...
    var cm = tm.CMD, dm = [[], [], []], fm = Math.sqrt, pm = Math.atan2, gm = function (t, e) {
        var n, i, r, a, o, s, l = t.data, u = cm.M, h = cm.C, c = cm.L, d = cm.R, f = cm.A, p = cm.Q;
        for (r = 0, a = 0; r < l.length;) {
            switch (n = l[r++], a = r, i = 0, n) {
                ...
                case p:
                    ...
                    break;
                case f:
                    var g = e[4], v = e[5], m = fm(e[0] * e[0] + e[1] * e[1]), y = fm(e[2] * e[2] + e[3] * e[3]),
                        _ = pm(-e[1] / y, e[0] / m);
    ...
    }, vm = Math.sqrt, mm = Math.sin, ym = Math.cos, _m = Math.PI, xm = function (t) {
        return Math.sqrt(t[0] * t[0] + t[1] * t[1])
    }, wm = function (t, e) {
        return (t[0] * e[0] + t[1] * e[1]) / (xm(t) * xm(e))
    }, bm = function (t, e) {
        return (t[0] * e[1] < t[1] * e[0] ? -1 : 1) * Math.acos(wm(t, e))
    }, Sm = /([mlvhzcqtsa])([^mlvhzcqtsa]*)/gi, Mm = /-?([0-9]*\.)?[0-9]+([eE]-?[0-9]+)?/g, Im = function (t) {
        Ti.call(this, t)
    };
    Im.prototype = {
        constructor: Im, type: "text", brush: function (t, e) {
            var n = this.style;
            this.__dirty && li(n, !0), n.fill = n.stroke = n.shadowBlur = n.shadowColor = n.shadowOffsetX = n.shadowOffsetY = null;
            var i = n.text;
            return null != i && (i += ""), Ii(i, n) ? (this.setTransform(t), hi(this, t, i, n, null, e), void this.restoreTransform(t)) : void (t.__attrCachedBy = vg.NONE)
        }, getBoundingRect: function () {
            var t = this.style;
    ...
    var Tm = ta.extend({
            ...
            return Kf.browser.ie && Kf.browser.version >= 11 ? function () {
                ...
                if (n) for (var r = 0; r < n.length; r++) {
                    ...
                    if (o && ("sector" === s && o.startAngle === o.endAngle || "rect" === s && (!o.width || !o.height))) {
                        for (var l = 0; l < Cm.length; l++) Cm[l][2] = i[Cm[l][0]], i[Cm[l][0]] = Cm[l][1];
                        e = !0;
                        break
                    }
                }
        ...
        }), Em = Math.round, zm = {}, Rm = ta.extend({
            type: "rect", shape: {r: 0, x: 0, y: 0, width: 0, height: 0}, buildPath: function (t, e) {
                var n, i, r, a;
                this.subPixelOptimize ? (ha(zm, e, this.style), n = zm.x, i = zm.y, r = zm.width, a = zm.height, zm.r = e.r, e = zm) : (n = e.x, i = e.y, r = e.width, a = e.height), e.r ? si(t, e) : t.rect(n, i, r, a), t.closePath()
            }
        }), Nm = {}, Fm = ta.extend({
            type: "line",
    ...
    Xm.prototype = {
        constructor: Xm, addColorStop: function (t, e) {
            this.colorStops.push({offset: t, color: e})
        }
    };
    var Ym = function (t, e, n, i, r, a) {
        this.x = null == t ? 0 : t, this.y = null == e ? 0 : e, this.x2 = null == n ? 1 : n, this.y2 = null == i ? 0 : i, this.type = "linear", this.global = a || !1, Xm.call(this, r)
    };
    Ym.prototype = {constructor: Ym}, h(Ym, Xm);
    var Um = function (t, e, n, i, r) {
        this.x = null == t ? .5 : t, this.y = null == e ? .5 : e, this.r = null == n ? .5 : n, this.type = "radial", this.global = r || !1, Xm.call(this, i)
    };
    Um.prototype = {constructor: Um}, h(Um, Xm), fa.prototype.incremental = !0, fa.prototype.clearDisplaybles = function () {
    ...
    fa.prototype.getBoundingRect = function () {
        if (!this._rect) {
            for (var t = new Tn(1 / 0, 1 / 0, -1 / 0, -1 / 0), e = 0; e < this._displayables.length; e++) {
                ...
                n.needLocalTransform() && i.applyTransform(n.getLocalTransform(qm)), t.union(i)
            }
            this._rect = t
        }
        return this._rect
    ...
    var jm = Math.max, Zm = Math.min, Km = {}, $m = 1,
        Qm = {color: "textFill", textBorderColor: "textStroke", textBorderWidth: "textStrokeWidth"}, Jm = "emphasis",
        ty = "normal", ey = 1, ny = {}, iy = {}, ry = oa, ay = ca, oy = N(), sy = 0;
    va("circle", Tm), va("sector", Am), va("ring", km), va("polygon", Om), va("polyline", Bm), va("rect", Rm), va("line", Fm), va("bezierCurve", Hm), va("arc", Gm);
    var ly = (Object.freeze || Object)({
        ...
        dy = {
            getItemStyle: function (t, e) {
                var n = cy(this, t, e), i = this.getBorderLineDash();
    ...
    fo.prototype = {
        constructor: fo, init: null, mergeOption: function (t) {
            ...
            var n = this.option, i = null == n ? n : n[t], r = !e && go(this, t);
    ...
    }, vr(fo), mr(fo), fy(fo, xv), fy(fo, bv), fy(fo, hy), fy(fo, dy);
    var gy = 0, vy = 1e-4, my = 9007199254740991,
        ...
        Sy = ["a", "b", "c", "d", "e", "f", "g"], My = function (t, e) {
            return "{" + t + (null == e ? "" : e) + "}"
        }, Iy = $n, Ty = (Object.freeze || Object)({
            addCommas: Ro,
            toCamelCase: No,
            ...
            getTextRect: qo
        }), Cy = f, Dy = ["left", "right", "top", "bottom", "width", "height"],
        Ay = [["width", "left", "right"], ["height", "top", "bottom"]], ky = jo,
        Py = (_(jo, "vertical"), _(jo, "horizontal"), {
            ...
            mergeDefaultAndTheme: function (t, e) {
                var n = this.layoutMode, i = n ? $o(t) : {}, a = e.getTheme();
    ...
    xr(Oy, {registerWhenExtend: !0}), mo(Oy), yo(Oy, Jo), c(Oy, Py);
    var By = "";
    ...
    var Ey = {
            ...
            clearColorPalette: function () {
                zy(this).colorIdx = 0, zy(this).colorNameMap = {}
            }, getColorFromPalette: function (t, e, n) {
                e = e || this;
                var i = zy(e), r = i.colorIdx || 0, a = i.colorNameMap = i.colorNameMap || {};
                if (a.hasOwnProperty(t)) return a[t];
                var o = Ji(this.get("color", !0)), s = this.get("colorLayer", !0), l = null != n && s ? ts(s, n) : o;
                if (l = l || o, l && l.length) {
                    var u = l[r];
                    return t && (a[t] = u), i.colorIdx = (r + 1) % l.length, u
                }
            }
        }, Ny = "original", Fy = "arrayRows", Vy = "objectRows", Hy = "keyedColumns", Gy = "unknown", Wy = "typedArray",
        Xy = "column", Yy = "row";
    es.seriesDataToSource = function (t) {
        return new es({data: t, sourceFormat: I(t) ? Wy : Ny, fromDataset: !1})
    }, mr(es);
    var Uy = {Must: 1, Might: 2, Not: 3}, qy = lr(), jy = "\x00_ec_inner", Zy = fo.extend({
        init: function (t, e, n, i) {
            n = n || {}, this.option = null, this._theme = new fo(n), this._optionManager = i
        }, setOption: function (t, e) {
            O(!(jy in t), "please use chart.getOption()"), this._optionManager.setOption(t, e), this.resetOption(null)
        }, resetOption: function (t) {
            var e = !1, n = this._optionManager;
            if (!t || "recreate" === t) {
                var i = n.mountOption("recreate" === t);
                this.option && "recreate" !== t ? (this.restoreData(), this.mergeOption(i)) : ms.call(this, i), e = !0
            }
            ...
            }), Oy.topologicalTravel(s, Oy.getAllClassMainTypes(), e, this), this._seriesIndicesMap = N(this._seriesIndices = this._seriesIndices || [])
        }, getOption: function () {
            var t = i(this.option);
            ...
            e.each(function (t, e) {
                n.push(e)
            }), Oy.topologicalTravel(n, Oy.getAllClassMainTypes(), function (n) {
    ...
    Ms.prototype = {
        constructor: Ms, setOption: function (t, e) {
            ...
            return this._timelineOptions = t_(e.timelineOptions, Jy), this._mediaList = t_(e.mediaList, Jy), this._mediaDefault = Jy(e.mediaDefault), this._currentMediaIndices = [], Jy(t ? e.baseOption : this._newBaseOption)
            ...
            return !r.length && i && (r = [-1]), r.length && !Ds(r, this._currentMediaIndices) && (a = t_(r, function (t) {
                return Jy(-1 === t ? i.option : n[t].option)
            })), this._currentMediaIndices = r, a
        }
    };
    var i_ = f, r_ = S, a_ = ["areaStyle", "lineStyle", "nodeStyle", "linkStyle", "chordStyle", "label", "labelLine"],
        o_ = function (t, e) {
            i_(zs(t.series), function (t) {
                r_(t) && Es(t)
            });
            var n = ["xAxis", "yAxis", "radiusAxis", "angleAxis", "singleAxis", "parallelAxis", "radar"];
            e && n.push("valueAxis", "categoryAxis", "logAxis", "timeAxis"), i_(n, function (e) {
                i_(zs(t[e]), function (t) {
                    t && (Os(t, "axisLabel"), Os(t.axisPointer, "label"))
                })
            }), i_(zs(t.parallel), function (t) {
                var e = t && t.parallelAxisDefault;
                Os(e, "axisLabel"), Os(e && e.axisPointer, "label")
            }), i_(zs(t.calendar), function (t) {
                Ps(t, "itemStyle"), Os(t, "dayLabel"), Os(t, "monthLabel"), Os(t, "yearLabel")
            }), i_(zs(t.radar), function (t) {
                Os(t, "name")
            }), i_(zs(t.geo), function (t) {
                r_(t) && (Bs(t), i_(zs(t.regions), function (t) {
                    Bs(t)
                }))
            }), i_(zs(t.timeline), function (t) {
                Bs(t), Ps(t, "label"), Ps(t, "itemStyle"), Ps(t, "controlStyle", !0);
                var e = t.data;
                x(e) && f(e, function (t) {
                    S(t) && (Ps(t, "label"), Ps(t, "itemStyle"))
                })
            }), i_(zs(t.toolbox), function (t) {
                Ps(t, "iconStyle"), i_(t.feature, function (t) {
                    Ps(t, "iconStyle")
                })
            }), Os(Rs(t.axisPointer), "label"), Os(Rs(t.tooltip).axisPointer, "label")
        }, s_ = [["x", "left"], ["y", "top"], ["x2", "right"], ["y2", "bottom"]],
        l_ = ["grid", "geo", "parallel", "legend", "toolbox", "title", "visualMap", "dataZoom", "timeline"],
        u_ = function (t, e) {
            o_(t, e), t.series = Ji(t.series), f(t.series, function (t) {
                if (S(t)) {
                    var e = t.type;
            ...
            }), t.dataRange && (t.visualMap = t.dataRange), f(l_, function (e) {
                var n = t[e];
    ...
    c_.pure = !1, c_.persistent = !0, c_.getSource = function () {
        return this._source
    };
    var d_ = {
        arrayRows_column: {
        ...
        arrayRows: qs, objectRows: function (t, e) {
            return js(t[e], this._dimensionInfos[e])
        }, keyedColumns: qs, original: function (t, e, n, i) {
        ...
        getDataParams: function (t, e) {
            ...
            return {
                ...
                marker: Go({color: s, renderMode: c}),
            ...
            if ("string" == typeof l) {
                var u = Vo(l, s);
                return u.replace(g_, function (e, n) {
                    var i = n.length;
    ...
    m_.perform = function (t) {
        ...
        (o !== l || s !== u) && (a = "reset");
        var h;
        (this._dirty || "reset" === a) && (this._dirty = !1, h = tl(this, i)), this._modBy = l, this._modDataCount = u;
        var c = t && t.step;
    ...
    var __ = lr(), x_ = Oy.extend({
        ...
        init: function (t, e, n) {
            this.seriesIndex = this.componentIndex, this.dataTask = $s({
                count: il,
                reset: rl
            }), this.dataTask.context = {model: this}, this.mergeDefaultAndTheme(t, n), as(this);
            var i = this.getInitialData(t, n);
            ol(i, this), this.dataTask.context.data = i, __(this).dataBeforeProcessed = i, el(this)
        },
        mergeDefaultAndTheme: function (t, e) {
            var n = this.layoutMode, i = n ? $o(t) : {}, a = this.subType;
            Oy.hasClass(a) && (a += "Series"), r(t, e.getTheme().get(this.subType)), r(t, this.getDefaultOption()), tr(t, "label", ["show"]), this.fillDataTextStyle(t.data), n && Ko(t, i, n)
        },
        mergeOption: function (t, e) {
            ...
            ol(i, this), this.dataTask.dirty(), this.dataTask.context.data = i, __(this).dataBeforeProcessed = i, el(this)
        },
        ...
        formatTooltip: function (t, e, n, i) {
            ...
            function a(t) {
                return {renderMode: i, content: Fo(Ro(t)), style: u}
            }
            ...
            var C = "string" == typeof M ? M : M.content, D = e ? C + T + w : T + C + (I ? Fo(I) + ": " + w : w);
        ...
        getColorFromPalette: function (t, e, n) {
            var i = this.ecModel, r = Ry.getColorFromPalette.call(this, t, e, n);
    ...
    c(x_, v_), c(x_, Ry);
    var w_ = function () {
        this.group = new hg, this.uid = vo("viewComponent")
    };
    w_.prototype = {
        constructor: w_, init: function () {
        }, render: function () {
        }, dispose: function () {
    ...
    }, vr(w_), xr(w_, {registerWhenExtend: !0});
    var S_ = function () {
        var t = lr();
        return function (e) {
            var n = t(e), i = e.pipelineContext, r = n.large, a = n.progressiveRender, o = n.large = i && i.large,
    ...
    T_.updateView = T_.updateLayout = T_.updateVisual = function (t, e, n, i) {
        this.render(t, e, n, i)
    }, vr(ul, ["dispose"]), xr(ul, {registerWhenExtend: !0}), ul.markUpdateMethod = function (t, e) {
        M_(t).updateMethod = e
    };
    var C_ = {
    ...
    }, D_ = "\x00__throttleOriginMethod", A_ = "\x00__throttleRate", k_ = "\x00__throttleType", P_ = {
        ...
        var n = new Rm({style: {fill: e.maskColor}, zlevel: e.zlevel, z: 1e4}), i = new Gm({
            shape: {startAngle: -B_ / 2, endAngle: -B_ / 2 + .1, r: 10},
        ...
        i.animateShape(!0).when(1e3, {endAngle: 3 * B_ / 2}).start("circularInOut"), i.animateShape(!0).when(1e3, {startAngle: 3 * B_ / 2}).delay(300).start("circularInOut");
        var a = new hg;
    ...
    z_.restoreData = function (t, e) {
        ...
        f(this._allHandlers, function (i) {
            ...
            i.reset && yl(this, i, r, e, n), i.overallReset && _l(this, i, r, e, n)
        }, this)
    }, z_.prepareView = function (t, e, n, i) {
        var r = t.renderTask, a = r.context;
        a.model = e, a.ecModel = n, a.api = i, r.__block = !t.incrementalPrepareRender, Dl(this, e, r)
    ...
    var F_, V_ = {}, H_ = {};
    kl(V_, Zy), kl(H_, bs), V_.eachSeriesByType = V_.eachRawSeriesByType = function (t) {
        F_ = t
    ...
    var G_ = ["#37A2DA", "#32C5E9", "#67E0E3", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#E062AE", "#E690D1", "#e7bcf3", "#9d96f5", "#8378EA", "#96BFFF"],
        W_ = {
            ...
            return {
                axisLine: {lineStyle: {color: X_}},
                axisTick: {lineStyle: {color: X_}},
                axisLabel: {textStyle: {color: X_}},
                splitLine: {lineStyle: {type: "dashed", color: "#aaa"}},
                splitArea: {areaStyle: {color: X_}}
            }
        },
        ...
        q_ = {
            color: U_,
            backgroundColor: "#333",
            tooltip: {axisPointer: {lineStyle: {color: X_}, crossStyle: {color: X_}, label: {color: "#000"}}},
            legend: {textStyle: {color: X_}},
            textStyle: {color: X_},
            title: {textStyle: {color: X_}},
            toolbox: {iconStyle: {normal: {borderColor: X_}}},
            dataZoom: {textStyle: {color: X_}},
            visualMap: {textStyle: {color: X_}},
            timeline: {
                lineStyle: {color: X_},
                itemStyle: {normal: {color: U_[1]}},
                label: {normal: {textStyle: {color: X_}}},
                controlStyle: {normal: {color: X_, borderColor: X_}}
            },
            timeAxis: Y_(),
            logAxis: Y_(),
            valueAxis: Y_(),
            ...
            line: {symbol: "circle"},
            graph: {color: U_},
            gauge: {title: {textStyle: {color: X_}}},
            candlestick: {
                itemStyle: {
                    normal: {
                        color: "#FD1050",
    ...
    q_.categoryAxis.splitLine.show = !1, Oy.extend({
        type: "dataset",
        defaultOption: {seriesLayoutBy: Xy, sourceHeader: null, dimensions: null, source: null},
        optionUpdated: function () {
            ns(this)
        }
    }), w_.extend({type: "dataset"});
    var j_ = ta.extend({
    ...
    Ll.prototype.parse = function (t, e) {
        ...
        isNaN(a) && (a = null), isNaN(o) && (o = null), zl(n, i, null, !0);
        ...
        if (l && null != a && null != o && (u = Vl(l, a, o), !e.ignoreViewBox)) {
            var c = i;
            i = new hg, i.add(c), c.scale = u.scale.slice(), c.position = u.position.slice()
        }
    ...
    var K_ = {
            g: function (t, e) {
                var n = new hg;
                return Bl(e, n), zl(t, n, this._defs), n
            }, rect: function (t, e) {
                var n = new Rm;
                return Bl(e, n), zl(t, n, this._defs), n.setShape({
                ...
                n && (n = El(n));
                var i = new Om({shape: {points: n || []}});
                return Bl(e, i), zl(t, i, this._defs), i
            }, polyline: function (t, e) {
                var n = new ta;
                Bl(e, n), zl(t, n, this._defs);
                var i = t.getAttribute("points");
                i && (i = El(i));
                var r = new Bm({shape: {points: i || []}});
                return r
            }, image: function (t, e) {
                var n = new Ci;
                return Bl(e, n), zl(t, n, this._defs), n.setStyle({
                ...
                var o = new hg;
                return Bl(e, o), zl(t, o, this._defs), o
            }, tspan: function (t, e) {
                var n = t.getAttribute("x"), i = t.getAttribute("y");
                null != n && (this._textX = parseFloat(n)), null != i && (this._textY = parseFloat(i));
                var r = t.getAttribute("dx") || 0, a = t.getAttribute("dy") || 0, o = new hg;
                return Bl(e, o), zl(t, o, this._defs), this._textX += r, this._textY += a, o
            }, path: function (t, e) {
                var n = t.getAttribute("d") || "", i = ra(n);
                return Bl(e, i), zl(t, i, this._defs), i
            }
        }, $_ = {
        ...
        }, J_ = /url\(\s*#(.*?)\)/, tx = /(translate|scale|rotate|skewX|skewY|matrix)\(([\-\s0-9\.e,]*)\)/g,
        ex = /([^\s:;]+)\s*:\s*([^:;]+)/g, nx = N(), ix = {
        ...
        }, ax = O, ox = f, sx = w, lx = S, ux = Oy.parseClassType, hx = "4.7.0", cx = {zrender: "4.3.0"}, dx = 1, fx = 1e3,
        px = 800, gx = 900, vx = 5e3, mx = 1e3, yx = 1100, _x = 2e3, xx = 3e3, bx = 3500, Sx = 4e3, Mx = 5e3, Ix = {
            PROCESSOR: {FILTER: fx, SERIES_FILTER: px, STATISTIC: vx},
            VISUAL: {
                LAYOUT: mx,
        ...
        }, Tx = "__flagInMainProcess", Cx = "__optionUpdated", Dx = /^[a-zA-Z0-9_]+$/;
    Gl.prototype.on = Hl("on", !0), Gl.prototype.off = Hl("off", !0), Gl.prototype.one = Hl("one", !0), c(Gl, yp);
    var Ax = Wl.prototype;
    Ax._onframe = function () {
        if (!this._disposed) {
            ...
            if (this[Cx]) {
                ...
                this[Tx] = !0, Yl(this), kx.update.call(this), this[Tx] = !1, this[Cx] = !1, Zl.call(this, e), Kl.call(this, e)
            } else if (t.unfinished) {
                var n = dx, i = this._model, r = this._api;
                t.unfinished = !1;
                do {
                    var a = +new Date;
        ...
        if (!this._disposed) {
            ...
            if (lx(e) && (n = e.lazyUpdate, i = e.silent, e = e.notMerge), this[Tx] = !0, !this._model || e) {
                var r = new Ms(this._api), a = this._theme, o = this._model = new Zy;
                o.scheduler = this._scheduler, o.init(null, null, a, r)
            }
            this._model.setOption(t, Ex), n ? (this[Cx] = {silent: i}, this[Tx] = !1) : (Yl(this), kx.update.call(this), this._zr.flush(), this[Cx] = !1, this[Tx] = !1, Zl.call(this, i), Kl.call(this, i))
        }
        ...
        if (!this._disposed && Kf.canvasSupported) {
            ...
            if (Hx[e]) {
                ...
                return t.connectedBackgroundColor && v.add(new Rm({
                    ...
                    var e = new Ci({style: {x: t.left * c - o, y: t.top * c - s, image: t.dom}});
                    v.add(e)
                }), v.refreshImmediately(), g.toDataURL("image/" + (t && t.type || "png"))
            }
            return this.getDataURL(t)
        }
    }, Ax.convertToPixel = _(Xl, "convertToPixel"), Ax.convertFromPixel = _(Xl, "convertFromPixel"), Ax.containPixel = function (t, e) {
        if (!this._disposed) {
            var n, i = this._model;
        ...
        var n = this._model;
        t = ur(n, t, {defaultMainType: "series"});
    ...
    var kx = {
        prepareAndUpdate: function (t) {
            Yl(this), kx.update.call(this, t)
        }, update: function (t) {
            var e = this._model, n = this._api, i = this._zr, r = this._coordSysMgr, a = this._scheduler;
            if (e) {
                a.restoreData(e, t), a.performSeriesTasks(e), r.create(e, n), a.performDataProcessorTasks(e, t), ql(this, e), r.update(e, n), Jl(e), a.performVisualTasks(e, t), tu(this, e, n, t);
                var o = e.get("backgroundColor") || "transparent";
                if (Kf.canvasSupported) i.setBackgroundColor(o); else {
                    var s = Je(o);
            ...
            if (e) {
                ...
                }), Jl(e), this._scheduler.performVisualTasks(e, t, {
                    setDirty: !0,
                    dirtyMap: a
                }), nu(n, e, i, t, a), iu(e, this._api)
            }
        }, updateView: function (t) {
            var e = this._model;
            e && (ul.markUpdateMethod(t, "updateView"), Jl(e), this._scheduler.performVisualTasks(e, t, {setDirty: !0}), tu(this, this._model, this._api, t), iu(e, this._api))
    ...
    Ax.resize = function (t) {
        if (!this._disposed) {
            ...
            if (this._loadingFX && this._loadingFX.resize(), e) {
                ...
                this[Tx] = !0, n && Yl(this), kx.update.call(this), this[Tx] = !1, Zl.call(this, i), Kl.call(this, i)
            }
        }
    }, Ax.showLoading = function (t, e) {
        if (!this._disposed && (lx(t) && (e = t, t = ""), t = t || "default", this.hideLoading(), Fx[t])) {
            var n = Fx[t](this._api, e), i = this._zr;
        ...
        var e = o({}, t);
        return e.type = Ox[t.type], e
    }, Ax.dispatchAction = function (t, e) {
        if (!this._disposed && (lx(e) || (e = {silent: !!e}), Lx[t.type] && this._model)) {
            if (this[Tx]) return void this._pendingActions.push(t);
            jl.call(this, t, e.silent), e.flush ? this._zr.flush(!0) : e.flush !== !1 && Kf.browser.weChat && this._throttledZrFlush(), Zl.call(this, e.silent), Kl.call(this, e.silent)
        }
    ...
    }, Ax.on = Hl("on", !1), Ax.off = Hl("off", !1), Ax.one = Hl("one", !1);
    ...
    Ax._initEvents = function () {
        ...
        if (!this._disposed) {
            this._disposed = !0, cr(this.getDom(), Xx, "");
            var t = this._api, e = this._model;
            ox(this._componentsViews, function (n) {
                n.dispose(e, t)
            }), ox(this._chartsViews, function (n) {
                n.dispose(e, t)
            }), this._zr.dispose(), delete Vx[this.id]
        }
    }, c(Wl, yp), lu.prototype = {
        constructor: lu, normalizeQuery: function (t) {
            var e = {}, n = {}, i = {};
            if (b(t)) {
                var r = ux(t);
    ...
    var Lx = {}, Ox = {}, Bx = [], Ex = [], zx = [], Rx = [], Nx = {}, Fx = {}, Vx = {}, Hx = {}, Gx = new Date - 0,
        Wx = new Date - 0, Xx = "_echarts_instance_", Yx = du;
    Mu(_x, P_), mu(u_), yu(gx, h_), Tu("default", E_), xu({
        type: "highlight",
        event: "highlight",
        update: "highlight"
    }, V), xu({type: "downplay", event: "downplay", update: "downplay"}, V), vu("light", W_), vu("dark", q_);
    var Ux = {};
    Eu.prototype = {
    ...
    var qx = N(["tooltip", "label", "itemName", "itemId", "seriesName"]), jx = S, Zx = "undefined", Kx = -1,
        $x = "e\x00\x00", Qx = {
            ...
            number: Array,
            time: Array
        }, Jx = typeof Uint32Array === Zx ? Array : Uint32Array, tw = typeof Int32Array === Zx ? Array : Int32Array,
        ...
        iw = ["_extent", "_approximateExtent", "_rawExtent"], rw = function (t, e) {
            t = t || ["x", "y"];
    ...
    aw.type = "list", aw.hasItemOption = !0, aw.getDimension = function (t) {
        ...
        for (var n = this._chunkSize, i = this._storage, r = this.dimensions, a = r.length, o = this._rawExtent, s = this.count(), l = s + Math.max(t.length, e ? e.length : 0), u = this._chunkCount, h = 0; a > h; h++) {
            var c = r[h];
            o[c] || (o[c] = th()), i[c] || (i[c] = []), Yu(i, this._dimensionInfos[c], n, u, l), this._chunkCount = i[c].length
        }
        ...
        if (!(t >= e)) {
            ...
            !r.persistent && r.clean && r.clean(), this._rawCount = this._count = e, this._extent = {}, Uu(this)
        }
    }, aw.count = function () {
        return this._count
        ...
        return a.length = l, a
    }, aw.getRawIndex = ju, aw.getRawDataItem = function (t) {
        ...
        if (this._count) {
            "function" == typeof t && (i = n, n = e, e = t, t = []), n = n || i || this, t = p($u(t), this.getDimension, this);
        ...
        if (this._count) {
            ...
            return r > u && (this._indices = o), this._count = u, this._extent = {}, this.getRawIndex = this._indices ? Zu : ju, this
        }
        ...
        if (this._count) {
            ...
            if (i) {
                ...
                return r > s && (this._indices = o), this._count = s, this._extent = {}, this.getRawIndex = this._indices ? Zu : ju, this
            }
        }
        ...
        n = n || i || this, t = p($u(t), this.getDimension, this);
        var r = Qu(this, t);
        r._indices = this._indices, r.getRawIndex = r._indices ? Zu : ju;
        ...
        return r._count = f, r._indices = d, r.getRawIndex = Zu, r
    ...
    aw.setItemGraphicEl = function (t, e) {
        ...
        e && (e.dataIndex = t, e.dataType = this.dataType, e.seriesIndex = n && n.seriesIndex, "group" === e.type && e.traverse(ow, e)), this._graphicEls[t] = e
        ...
        return t.getRawIndex = t._indices ? Zu : ju, t
    ...
    }, aw.TRANSFERABLE_METHODS = ["cloneShallow", "downSample", "map"], aw.CHANGABLE_METHODS = ["filterSelf", "selectRange"];
    var sw = function (t, e) {
    ...
    fh.prototype.parse = function (t) {
        ...
        this._isBlank = t
    }, fh.prototype.getLabel = null, vr(fh), xr(fh, {registerWhenExtend: !0}), ph.createByAxisModel = function (t) {
        var e = t.option, n = e.data, i = n && p(n, vh);
        return new ph({categories: i, needCollect: !i, deduplication: e.dedplication !== !1})
    };
    var uw = ph.prototype;
    ...
    var hw = fh.prototype, cw = fh.extend({
        type: "ordinal", init: function (t, e) {
            (!t || x(t)) && (t = new ph({categories: t})), this._ordinalMeta = t, this._extent = e || [0, t.categories.length - 1]
        }, parse: function (t) {
            return "string" == typeof t ? this._ordinalMeta.getOrdinal(t) : Math.round(t)
        }, contain: function (t) {
            return t = this.parse(t), hw.contain.call(this, t) && null != this._ordinalMeta.categories[t]
    ...
    var dw = bo, fw = bo, pw = fh.extend({
        type: "interval", _interval: 0, _intervalPrecision: 2, setExtent: function (t, e) {
            ...
            return n[1] > l && a.push(t ? fw(l + e, r) : n[1]), a
            ...
            if (null == t) return "";
            var n = e && e.precision;
            return null == n ? n = Io(t) || 0 : "auto" === n && (n = this._intervalPrecision), t = fw(t, n, !0), Ro(t)
            ...
            t.fixMin || (e[0] = fw(Math.floor(e[0] / r) * r)), t.fixMax || (e[1] = fw(Math.ceil(e[1] / r) * r))
        }
    });
    pw.create = function () {
        return new pw
    };
    var gw = "__ec_stack_", vw = .5, mw = "undefined" != typeof Float32Array ? Float32Array : Array, yw = {
            seriesType: "bar", plan: S_(), reset: function (t) {
                function e(t, e) {
                    for (var n, d = t.count, f = new mw(2 * d), p = new mw(2 * d), g = new mw(d), v = [], m = [], y = 0, _ = 0; null != (n = t.next());) m[h] = e.get(s, n), m[1 - h] = e.get(l, n), v = i.dataToPoint(m, null, v), p[y] = u ? r.x + r.width : v[0], f[y++] = v[0], p[y] = u ? v[1] : r.y + r.height, f[y++] = v[1], g[_++] = n;
                    e.setLayout({
                        largePoints: f,
                        largeDataIndices: g,
                ...
                if (Ah(t) && kh(t)) {
                    var n = t.getData(), i = t.coordinateSystem, r = i.grid.getRect(), a = i.getBaseAxis(),
                        o = i.getOtherAxis(a), s = n.mapDimension(o.dim), l = n.mapDimension(a.dim), u = o.isHorizontal(),
                        h = u ? 0 : 1, c = Ch(Ih([t]), a, t).width;
                    return c > vw || (c = vw), {progress: e}
                }
            }
        }, _w = pw.prototype, xw = Math.ceil, ww = Math.floor, bw = 1e3, Sw = 60 * bw, Mw = 60 * Sw, Iw = 24 * Mw,
        Tw = function (t, e, n, i) {
            for (; i > n;) {
                var r = n + i >>> 1;
                t[r][1] < e ? n = r + 1 : i = r
            ...
            type: "time", getLabel: function (t) {
                ...
                if (e[0] === e[1] && (e[0] -= Iw, e[1] += Iw), e[1] === -1 / 0 && 1 / 0 === e[0]) {
                    var n = new Date;
                    e[1] = +new Date(n.getFullYear(), n.getMonth(), n.getDate()), e[0] = e[1] - Iw
                }
                this.niceTicks(t.splitNumber, t.minInterval, t.maxInterval);
                var i = this._interval;
                t.fixMin || (e[0] = bo(ww(e[0] / i) * i)), t.fixMax || (e[1] = bo(xw(e[1] / i) * i))
            }, niceTicks: function (t, e, n) {
                t = t || 10;
                var i = this._extent, r = i[1] - i[0], a = r / t;
                null != e && e > a && (a = e), null != n && a > n && (a = n);
                var o = Dw.length, s = Tw(Dw, a, 0, o), l = Dw[Math.min(s, o - 1)], u = l[1];
                if ("year" === l[0]) {
    ...
    Cw.create = function (t) {
        return new Cw({useUTC: t.ecModel.get("useUTC")})
    };
    var Aw = fh.prototype, kw = pw.prototype, Pw = Io, Lw = bo, Ow = Math.floor, Bw = Math.ceil, Ew = Math.pow,
        zw = Math.log, Rw = fh.extend({
            type: "log", base: 10, $constructor: function () {
                fh.apply(this, arguments), this._originalScale = new pw
            }, getTicks: function (t) {
                var e = this._originalScale, n = this._extent, i = e.getExtent();
                return p(kw.getTicks.call(this, t), function (t) {
                    var r = bo(Ew(this.base, t));
                    return r = t === n[0] && e.__fixMin ? Lh(r, i[0]) : r, r = t === n[1] && e.__fixMax ? Lh(r, i[1]) : r
                }, this)
            }, getMinorTicks: kw.getMinorTicks, getLabel: kw.getLabel, scale: function (t) {
                return t = Aw.scale.call(this, t), Ew(this.base, t)
            }, setExtent: function (t, e) {
                var n = this.base;
                t = zw(t) / zw(n), e = zw(e) / zw(n), kw.setExtent.call(this, t, e)
            }, getExtent: function () {
                var t = this.base, e = Aw.getExtent.call(this);
                e[0] = Ew(t, e[0]), e[1] = Ew(t, e[1]);
                var n = this._originalScale, i = n.getExtent();
                return n.__fixMin && (e[0] = Lh(e[0], i[0])), n.__fixMax && (e[1] = Lh(e[1], i[1])), e
            }, unionExtent: function (t) {
                this._originalScale.unionExtent(t);
                var e = this.base;
                t[0] = zw(t[0]) / zw(e), t[1] = zw(t[1]) / zw(e), Aw.unionExtent.call(this, t)
            }, unionExtentFromData: function (t, e) {
                this.unionExtent(t.getApproximateExtent(e))
    ...
    f(["contain", "normalize"], function (t) {
        Rw.prototype[t] = function (e) {
            return e = zw(e) / zw(this.base), Aw[t].call(this, e)
        }
    }), Rw.create = function () {
        return new Rw
    };
    ...
    var Uw = pa({
        ...
        buildPath: function (t, e, n) {
            ...
            if ("none" !== i) {
                var r = Yw[i];
                r || (i = "rect", r = Yw[i]), Xw[i](e.x, e.y, e.width, e.height, r.shape), r.buildPath(t, r.shape, n)
            }
        }
    }), qw = {isDimensionStacked: lh, enableDataStack: sh, getStackedDimension: uh}, jw = (Object.freeze || Object)({
        createList: Uh,
        getLayoutRect: Zo,
        dataStack: qw,
        createScale: qh,
    ...
    $h.prototype = {
        constructor: $h, properties: null, getBoundingRect: function () {
            var t = this._rect;
            if (t) return t;
    ...
    Jw.prototype = {
        constructor: Jw, contain: function (t) {
            ...
            return t = i.normalize(t), this.onBand && "ordinal" === i.type && (n = n.slice(), pc(n, i.count())), xo(t, Qw, n, e)
            ...
            t = t || {};
            var e = t.tickModel || this.getTickModel(), n = ec(this, e), i = n.ticks, r = p(i, function (t) {
                return {coord: this.dataToCoord(t), tickValue: t}
            }, this), a = e.get("alignWithLabel");
            return gc(this, r, a, t.clamp), r
    ...
    ib.prototype = {
        constructor: ib, type: "cartesian", getAxis: function (t) {
            return this._axes[t]
        }, getAxes: function () {
        ...
        constructor: mc, type: "cartesian2d", dimensions: ["x", "y"], getBaseAxis: function () {
            ...
            var t = this.getAxis("x").getGlobalExtent(), e = this.getAxis("y").getGlobalExtent(),
                ...
                a = Math.max(e[0], e[1]) - i, o = new Tn(n, i, r, a);
            return o
        }
    }, h(mc, ib);
    var rb = function (t, e, n, i, r) {
        Jw.call(this, t, e, n), this.type = i || "value", this.position = r || "bottom"
    };
    rb.prototype = {
    ...
    }, ab), ob.timeAxis = s({scale: !0, min: "dataMin", max: "dataMax"}, ob.valueAxis), ob.logAxis = s({
        scale: !0,
        logBase: 10
    }, ob.valueAxis);
    var sb = ["value", "category", "time", "log"], lb = function (t, e, n, i) {
        f(sb, function (o) {
            e.extend({
                type: t + "Axis." + o, mergeDefaultAndTheme: function (e, i) {
                    var a = this.layoutMode, s = a ? $o(e) : {}, l = i.getTheme();
                ...
                }, defaultOption: a([{}, ob[o + "Axis"], i], !0)
            })
        }), Oy.registerSubTypeDefaulter(t + "Axis", _(n, t))
    }, ub = Oy.extend({
        type: "cartesian2dAxis", axis: null, init: function () {
            ub.superApply(this, "init", arguments), this.resetRange()
        }, mergeOption: function () {
            ub.superApply(this, "mergeOption", arguments), this.resetRange()
        }, restoreData: function () {
            ub.superApply(this, "restoreData", arguments), this.resetRange()
    ...
    r(ub.prototype, Nw);
    var hb = {offset: 0};
    lb("x", ub, yc, hb), lb("y", ub, yc, hb), Oy.extend({
        type: "grid",
    ...
    var cb = xc.prototype;
    cb.type = "grid", cb.axisPointerEnabled = !0, cb.getRect = function () {
        return this._rect
        ...
        function n(n) {
            return function (o, s) {
                if (_c(o, t, e)) {
                    ...
                    var u = new rb(n, zh(o), [0, 0], o.get("type"), l), h = "category" === u.type;
    ...
    xc.create = function (t, e) {
        ...
        return t.eachComponent("grid", function (i, r) {
            ...
            if (Ic(e)) {
                var n = Mc(e, t), i = n[0], r = n[1], a = i.getCoordSysModel(), o = a.coordinateSystem;
                e.coordinateSystem = o.getCartesian(i.componentIndex, r.componentIndex)
            }
        }), n
    }, xc.dimensions = xc.prototype.dimensions = mc.prototype.dimensions, Ss.register("cartesian2d", xc);
    var fb = x_.extend({
        type: "series.__base_bar__",
        getInitialData: function () {
            return hh(this.getSource(), this, {useEncodeDefaulter: !0})
        },
    ...
    var pb = yv([["fill", "color"], ["stroke", "borderColor"], ["lineWidth", "borderWidth"], ["stroke", "barBorderColor"], ["lineWidth", "barBorderWidth"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"]]),
        ...
        }), mb = ["itemStyle", "barBorderWidth"], yb = [0, 0];
    o(fo.prototype, gb), ku({
        type: "bar", render: function (t, e, n) {
            ...
            var s = t.isAnimationEnabled() ? t : null, l = t.get("clip", !0), u = Lc(a, i);
            n.removeClipPath();
            ...
            i.diff(r).add(function (r) {
                var o = i.getItemModel(r), p = Sb[a.type](i, r, o);
                if (c) {
                    var g = Wc(a, e, p);
                ...
                if (i.hasValue(r)) {
                    ...
                    i.setItemGraphicEl(r, m), n.add(m), zc(m, i, r, o, p, t, e, "polar" === a.type)
                }
            }).update(function (o, g) {
                var v = i.getItemModel(o), m = Sb[a.type](i, o, v);
                if (c) {
                    var y = p[g];
                ...
                x ? Ja(x, {shape: m}, s, o) : x = bb[a.type](o, m, e, s, !0, h), i.setItemGraphicEl(o, x), n.add(x), zc(x, i, o, v, m, t, e, "polar" === a.type)
            }).remove(function (t) {
            ...
            this._removeBackground(), Nc(e, this.group, !0)
    ...
    var _b = Math.max, xb = Math.min, wb = {
        ...
        cartesian2d: function (t, e, n, i, r) {
            var a = new Rm({shape: o({}, e), z2: 1});
            if (a.name = "item", i) {
                var s = a.shape, l = n ? "height" : "width", u = {};
                s[l] = 0, u[l] = e[l], ly[r ? "updateProps" : "initProps"](a, {shape: u}, i, t)
            }
            return a
        }, polar: function (t, e, n, i, r, a) {
            var o = e.startAngle < e.endAngle, l = !n && a ? vb : Am, u = new l({shape: s({clockwise: o}, e), z2: 1});
            if (u.name = "item", i) {
                var h = u.shape, c = n ? "r" : "endAngle", d = {};
                h[c] = n ? 0 : e.startAngle, d[c] = e[c], ly[r ? "updateProps" : "initProps"](u, {shape: d}, i, t)
            }
            return u
        }
    }, Sb = {
        ...
        var e = this, n = Fc(e, t.offsetX, t.offsetY);
        e.dataIndex = n >= 0 ? n : null
    }, 30, !1), Tb = Math.PI, Cb = function (t, e) {
        ...
        var n = new hg({position: e.position.slice(), rotation: e.rotation});
        n.updateTransform(), this._transform = n.transform, this._dumbGroup = n
    };
    Cb.prototype = {
        constructor: Cb, hasBuilder: function (t) {
            return !!Db[t]
        }, add: function (t) {
            Db[t].call(this)
        }, getGroup: function () {
    ...
    var Db = {
        axisLine: function () {
                ...
                if ("number" == typeof h && (h = [h, h]), null != l) {
                    ...
                    f([{rotate: t.rotation + Math.PI / 2, offset: h[0], r: 0}, {
                        ...
                        if ("none" !== l[n] && null != l[n]) {
                            var i = Yh(l[n], -c / 2, -d / 2, c, d, s.stroke, !0), a = e.r + e.offset,
            ...
            var t = this.axisModel, e = this.opt, n = Kc(this, t, e), i = Qc(this, t, e);
            Yc(t, i, n), $c(this, t, e)
        }, axisName: function () {
            ...
            if (n) {
                ...
                var p = s.getFont(), g = e.get("nameTruncate", !0) || {}, v = g.ellipsis,
                    ...
                    y = null != v && null != m ? Iy(n, m, p, v, {minChar: 2, placeholder: g.placeholder}) : n,
                ...
                }), e.get("triggerEvent") && (b.eventData = Ab(e), b.eventData.targetType = "axisName", b.eventData.name = n), this._dumbGroup.add(b), b.updateTransform(), this.group.add(b), b.decomposeTransform()
            }
        }
        ...
        type: "axis", _axisPointer: null, axisPointerClass: null, render: function (t, e, n, i) {
            this.axisPointerClass && ad(t), Bb.superApply(this, "render", arguments), hd(this, t, e, n, i, !0)
            ...
            cd(this, e), Bb.superApply(this, "dispose", arguments)
        }
    }), Eb = [];
    ...
    var zb = ["axisLine", "axisTickLabel", "axisName"], Rb = ["splitArea", "splitLine", "minorSplitLine"],
        Nb = Bb.extend({
            type: "cartesianAxis", axisPointerClass: "CartesianAxisPointer", render: function (t, e, n, i) {
                ...
                if (this._axisGroup = new hg, this.group.add(this._axisGroup), t.get("show")) {
                    var a = t.getCoordSysModel(), o = dd(a, t), s = new Cb(t, o);
                    f(zb, s.add, s), this._axisGroup.add(s.getGroup()), f(Rb, function (e) {
                        t.get(e + ".show") && this["_" + e](t, a)
                    }, this), ro(r, this._axisGroup, t), Nb.superCall(this, "render", t, e, n, i)
                }
            }, remove: function () {
                pd(this)
                ...
                if (s.length) for (var l = [], u = [], h = r.getLineStyle(), c = 0; c < s.length; c++) for (var d = 0; d < s[c].length; d++) {
                    ...
                    o ? (l[0] = f, l[1] = a.y, u[0] = f, u[1] = a.y + a.height) : (l[0] = a.x, l[1] = f, u[0] = a.x + a.width, u[1] = f), this._axisGroup.add(new Fm({
    ...
    Nb.extend({type: "xAxis"}), Nb.extend({type: "yAxis"}), Du({
        type: "grid", render: function (t) {
            this.group.removeAll(), t.get("show") && this.group.add(new Rm({
    ...
    }), Su(Ix.VISUAL.LAYOUT, _(Dh, "bar")), Su(Ix.VISUAL.PROGRESSIVE_LAYOUT, yw), Mu({
        seriesType: "bar",
        reset: function (t) {
    ...
    var Fb = gd.prototype, Vb = gd.getSymbolSize = function (t, e) {
        var n = t.getItemVisual(e, "symbolSize");
        return n instanceof Array ? n.slice() : [+n, +n]
    };
    Fb._createSymbol = function (t, e, n, i, r) {
        this.removeAll();
        var a = e.getItemVisual(n, "color"), o = Yh(t, -1, -1, 2, 2, a, r);
        o.attr({z2: 100, culling: !0, scale: vd(i)}), o.drift = md, this._symbolType = t, this.add(o)
        ...
        this.silent = !1;
        var i = t.getItemVisual(e, "symbol") || "circle", r = t.hostModel, a = Vb(t, e), o = i !== this._symbolType;
        if (o) {
    ...
    var Hb = ["itemStyle"], Gb = ["emphasis", "itemStyle"], Wb = ["label"], Xb = ["emphasis", "label"];
    Fb._updateCommon = function (t, e, n, i) {
        ...
        if (!i || t.hasItemOption) {
            ...
            u = m.getModel(Hb).getItemStyle(["color"]), h = m.getModel(Gb).getItemStyle(), c = m.getShallow("symbolRotate"), d = m.getShallow("symbolOffset"), f = m.getModel(Wb), p = m.getModel(Xb), g = m.getShallow("hoverAnimation"), v = m.getShallow("cursor")
        } else h = o({}, h);
        var y = a.style;
        ...
        Ha(y, h, f, p, {
            ...
            isRectText: !0,
            autoColor: l
        }), a.__symbolOriginalScale = vd(n), a.hoverStyle = h, a.highDownOnUpdate = g && s.isAnimationEnabled() ? yd : null, Ra(a)
    ...
    Yb.updateData = function (t, e) {
        e = wd(e);
        var n = this.group, i = t.hostModel, r = this._data, a = this._symbolCtor, o = bd(t);
        r || n.removeAll(), t.diff(r).add(function (i) {
            ...
            return xd(t, h, s, e) ? (u ? (u.updateData(t, s, o), Ja(u, {position: h}, i)) : (u = new a(t, s), u.attr("position", h)), n.add(u), void t.setItemGraphicEl(s, u)) : void n.remove(u)
        }).remove(function (t) {
            var e = r.getItemGraphicEl(t);
    ...
    var Ub = function (t, e, n, i, r, a, o, s) {
        for (var l = Td(t, e), u = [], h = [], c = [], d = [], f = [], p = [], g = [], v = Sd(r, e, o), m = Sd(a, t, s), y = 0; y < l.length; y++) {
            ...
            switch (_.cmd) {
                ...
                case"+":
                    var S = _.idx;
                    u.push(r.dataToPoint([e.get(v.dataDimsForPoint[0], S), e.get(v.dataDimsForPoint[1], S)])), h.push(e.getItemLayout(S).slice()), c.push(Id(v, r, e, S)), d.push(i[S]), g.push(e.getRawIndex(S));
                    break;
                case"-":
        ...
        buildPath: function (t, e) {
            var n = e.points, i = e.stackedOnPoints, r = 0, a = n.length, o = e.smoothMonotone,
                s = Pd(n, e.smoothConstraint), l = Pd(i, e.smoothConstraint);
            if (e.connectNulls) {
                for (; a > 0 && Cd(n[a - 1]); a--) ;
                for (; a > r && Cd(n[r]); r++) ;
            }
            for (; a > r;) {
                ...
                Dd(t, i, r + u - 1, u, a, -1, l.min, l.max, e.stackedOnSmooth, o, e.connectNulls), r += u + 1, t.closePath()
            }
        }
    });
    ul.extend({
        type: "line", init: function () {
            var t = new hg, e = new _d;
            ...
            var i = t.coordinateSystem, r = this.group, a = t.getData(), o = t.getModel("lineStyle"),
                ...
                v = t.get("animation"), m = !l.isEmpty(), y = l.get("origin"), _ = Sd(i, a, y), x = Bd(i, a, _),
            ...
            i && i.getArea && t.get("clip", !0) && (M = i.getArea(), null != M.width ? (M.x -= .1, M.y -= .1, M.width += .2, M.height += .2) : M.r0 && (M.r0 -= .5, M.r1 += .5)), this._clipShapeForSymbol = M, f && c.type === i.type && I === this._step ? (m && !p ? p = this._newPolygon(u, x, i, v) : p && !m && (g.remove(p), p = this._polygon = null), g.setClipPath(Fd(i, !1, t)), w && d.updateData(a, {
                isIgnore: b,
                clipShape: M
            }), a.eachItemGraphicEl(function (t) {
                t.stopAnimation(!0)
            }), Ld(this._stackedOnPoints, x) && Ld(this._points, u) || (v ? this._updateAnimation(a, x, i, n, I, y) : (I && (u = Ed(u, i, I), x = Ed(x, i, I)), f.setShape({points: u}), p && p.setShape({
                points: u,
                stackedOnPoints: x
            })))) : (w && d.updateData(a, {
                isIgnore: b,
            ...
            if (C = Od(t.get("smooth")), f.setShape({
                ...
                p.useStyle(s(l.getAreaStyle(), {
                    ...
                    opacity: .7,
                    lineJoin: "bevel"
                })), D && (A = Od(D.get("smooth"))), p.setShape({
                    smooth: C,
                    stackedOnSmooth: A,
                    smoothMonotone: t.get("smoothMonotone"),
                    connectNulls: t.get("connectNulls")
            ...
            if (!(a instanceof Array) && null != a && a >= 0) {
                ...
                if (!o) {
                    ...
                    o = new gd(r, a), o.position = s, o.setZ(t.get("zlevel"), t.get("z")), o.ignore = isNaN(s[0]) || isNaN(s[1]), o.__temp = !0, r.setItemGraphicEl(a, o), o.stopSymbolAnimation(!0), this.group.add(o)
                }
                o.highlight()
            ...
            return e && this._lineGroup.remove(e), e = new tS({
                shape: {points: t},
                silent: !0,
                z2: 10
            ...
            var n = this._polygon;
            return n && this._lineGroup.remove(n), n = new eS({
            ...
            var o = this._polyline, s = this._polygon, l = t.hostModel,
                u = Ub(this._data, t, this._stackedOnPoints, e, this._coordSys, n, this._valueOrigin, a), h = u.current,
                c = u.stackedOnCurrent, d = u.next, f = u.stackedOnNext;
            r && (h = Ed(u.current, n, r), c = Ed(u.stackedOnCurrent, n, r), d = Ed(u.next, n, r), f = Ed(u.stackedOnNext, n, r)), o.shape.__points = u.current, o.shape.points = h, Ja(o, {shape: {points: d}}, l), s && (s.setShape({
                points: h,
                stackedOnPoints: c
    ...
    var nS = function (t, e, n) {
        ...
        return {
            seriesType: t, plan: S_(), reset: function (t) {
                function e(t, e) {
                ...
                if (i) {
                    ...
                    return lh(n, o[0]) && (o[0] = l), lh(n, o[1]) && (o[1] = l), s && {progress: e}
                }
            }
        }
    }, rS = {
        ...
        return {
            seriesType: t, modifyOutputEnd: !0, reset: function (t) {
                ...
                if ("cartesian2d" === i.type && n) {
                    ...
                    if (l > 1) {
                        var u;
                        "string" == typeof n ? u = rS[n] : "function" == typeof n && (u = n), u && t.setData(e.downSample(e.mapDimension(a.dim), 1 / l, u, aS))
                    }
                }
            }
        }
    };
    Mu(nS("line", "circle", "line")), Su(iS("line")), yu(Ix.PROCESSOR.STATISTIC, oS("line"));
    var sS = function (t, e, n) {
        e = x(e) && {coordDimensions: e} || o({}, e);
        var i = t.getSource(), r = sw(i, e), a = new rw(r, t);
        ...
        type: "series.pie",
        init: function (t) {
            uS.superApply(this, "init", arguments), this.legendVisualProvider = new Vd(y(this.getData, this), y(this.getRawData, this)), this.updateSelectedMap(this._createSelectableList()), this._defaultLabelLine(t)
        },
        mergeOption: function (t) {
            uS.superCall(this, "mergeOption", t), this.updateSelectedMap(this._createSelectableList())
        },
        getInitialData: function () {
            return sS(this, {coordDimensions: ["value"], encodeDefaulter: _(cs, this)})
        },
    ...
    hS.updateData = function (t, e, n) {
        ...
        if (n) {
            ...
            "scale" === f ? (i.shape.r = h.r0, to(i, {shape: {r: h.r}}, l, e)) : (i.shape.endAngle = h.startAngle, Ja(i, {shape: {endAngle: h.endAngle}}, l, e))
        } else "expansion" === d ? i.setShape(c) : Ja(i, {shape: c}, l, e);
        ...
        g && i.attr("cursor", g), Gd(this, t.getItemLayout(e), l.isSelected(t.getName(e)), l.get("selectedOffset"), l.get("animation"));
        ...
        n ? (Ja(i, {shape: h}, a, e), Ja(r, {style: c}, a, e)) : (i.attr({shape: h}), r.attr({style: c})), r.attr({
            rotation: l.rotation,
            origin: [l.x, l.y],
            z2: 10
        });
    ...
    var cS = (ul.extend({
        type: "pie", init: function () {
            ...
            if (!i || i.from !== this.uid) {
                var r = t.getData(), a = this._data, o = this.group, s = e.get("animation"), l = !a,
                    u = t.get("animationType"), h = t.get("animationTypeUpdate"), c = _(Hd, this.uid, t, s, n),
            ...
            var l = new Am({shape: {cx: t, cy: e, r0: 0, r: n, startAngle: i, endAngle: i, clockwise: r}}),
                u = s ? to : Ja;
        ...
        f(e, function (e) {
            e.update = "updateView", xu(e, function (n, i) {
                var r = {};
    ...
    }, fS = Math.PI / 180, pS = function (t, e, n, i, r, a) {
        var o, s, l = t.getData(), u = [], h = !1, c = (t.get("minShowLabelAngle") || 0) * fS;
        l.each(function (i) {
            var a = l.getItemLayout(i), d = l.getItemModel(i), f = d.getModel("label"),
                ...
                v = f.get("alignTo"), m = wo(f.get("margin"), n), y = f.get("bleedMargin"), _ = f.getFont(),
            ...
            if (b = wo(b, n), !(a.angle < c)) {
                ...
                o = a.cx, s = a.cy;
                var k = t.getFormattedLabel(i, "normal") || l.getName(i), P = Yn(k, _, T, "top"),
                    L = "inside" === p || "inner" === p;
    ...
    }, gS = 2 * Math.PI, vS = Math.PI / 180, mS = function (t, e, n) {
        e.eachSeriesByType(t, function (t) {
            var e = t.getData(), i = e.mapDimension("value"), r = qd(t, n), a = t.get("center"), o = t.get("radius");
            x(o) || (o = [0, o]), x(a) || (a = [a, a]);
            var s = wo(r.width, n.getWidth()), l = wo(r.height, n.getHeight()), u = Math.min(s, l),
                h = wo(a[0], s) + r.x, c = wo(a[1], l) + r.y, d = wo(o[0], u / 2), f = wo(o[1], u / 2),
                p = -t.get("startAngle") * vS, g = t.get("minAngle") * vS, v = 0;
            e.each(i, function (t) {
                !isNaN(t) && v++
            });
            ...
            if (e.each(i, function (t, n) {
                ...
                i = "area" !== w ? 0 === m && b ? y : t * y : gS / v, g > i ? (i = g, M -= g) : I += t;
                var a = T + C * i;
                e.setItemLayout(n, {
                    angle: i,
                    startAngle: T,
    ...
    cS("pie", [{type: "pieToggleSelect", event: "pieselectchanged", method: "toggleSelected"}, {
        type: "pieSelect",
        event: "pieselected",
        method: "select"
    }, {
        ...
        event: "pieunselected",
        method: "unSelect"
    }]), Mu(dS("pie")), Su(_(mS, "pie")), yu(yS("pie")), Cu({
        type: "title",
        ...
        type: "title", render: function (t, e, n) {
            if (this.group.removeAll(), t.get("show")) {
                var i = this.group, r = t.getModel("textStyle"), a = t.getModel("subtextStyle"), o = t.get("textAlign"),
                    s = A(t.get("textBaseline"), t.get("textVerticalAlign")), l = new Im({
                        style: Wa({}, r, {text: t.get("text"), textFill: r.getTextColor()}, {disableBox: !0}),
                        z2: 10
                    }), u = l.getBoundingRect(), h = t.get("subtext"), c = new Im({
                        style: Wa({}, a, {
                            text: h,
                ...
                var m = Zo(v, {width: n.getWidth(), height: n.getHeight()}, t.get("padding"));
    ...
    var _S = L_.legend.selector,
        xS = {all: {type: "all", title: i(_S.all)}, inverse: {type: "inverse", title: i(_S.inverse)}}, wS = Cu({
            type: "legend.plain",
            dependencies: ["series"],
            layoutMode: {type: "box", ignoreSize: !0},
            init: function (t, e, n) {
            ...
            mergeOption: function (t) {
                wS.superCall(this, "mergeOption", t), this._updateSelector(t)
            },
            _updateSelector: function (t) {
                var e = t.selector;
                e === !0 && (e = t.selector = ["all", "inverse"]), x(e) && f(e, function (t, n) {
                    b(t) && (t = {type: t}), e[n] = r(t, xS[t.type])
                })
            },
            optionUpdated: function () {
    ...
    xu("legendToggleSelect", "legendselectchanged", _(jd, "toggleSelected")), xu("legendAllSelect", "legendselectall", _(jd, "allSelect")), xu("legendInverseSelect", "legendinverseselect", _(jd, "inverseSelect")), xu("legendSelect", "legendselected", _(jd, "select")), xu("legendUnSelect", "legendunselected", _(jd, "unSelect"));
    var bS = _, SS = f, MS = hg, IS = Du({
        type: "legend.plain", newlineDisabled: !1, init: function () {
            this.group.add(this._contentGroup = new MS), this._backgroundEl, this.group.add(this._selectorGroup = new MS), this._isFirstRender = !0
            ...
            if (this._isFirstRender = !1, this.resetInner(), t.get("show", !0)) {
                ...
                var u = t.getBoxLayoutParams(), h = {width: n.getWidth(), height: n.getHeight()}, c = t.get("padding"),
                    d = Zo(u, h, c), f = this.layoutInner(t, r, d, i, o, l),
                    p = Zo(s({width: f.width, height: f.height}, u), h, c);
                this.group.attr("position", [p.x - f.x, p.y - f.y]), this.group.add(this._backgroundEl = Zd(f, t))
            }
        }, resetInner: function () {
            ...
            n.eachRawSeries(function (t) {
            ...
            }), SS(e.getData(), function (r, a) {
                var o = r.get("name");
                if (!this.newlineDisabled && ("" === o || "\n" === o)) return void s.add(new MS({newline: !0}));
                ...
                if (!l.get(o)) if (c) {
                    ...
                    m.on("click", bS($d, o, null, i, h)).on("mouseover", bS(Qd, c.name, null, i, h)).on("mouseout", bS(Jd, c.name, null, i, h)), l.set(o, !0)
                    ...
                    if (!l.get(o) && n.legendVisualProvider) {
                        ...
                        g.on("click", bS($d, null, o, i, h)).on("mouseover", bS(Qd, null, o, i, h)).on("mouseout", bS(Jd, null, o, i, h)), l.set(o, !0)
                    }
                }, this)
            }, this), r && this._createSelector(r, e, i, a, o)
        }, _createSelector: function (t, e, n) {
            function i(t) {
                var i = t.type, a = new Im({
            ...
            var c = i.get("itemWidth"), d = i.get("itemHeight"), f = i.get("inactiveColor"),
                ...
                m = i.isSelected(t), y = new MS, _ = n.getModel("textStyle"), x = n.get("icon"),
            ...
            "string" == typeof D && D ? A = D.replace("{name}", null != t ? t : "") : "function" == typeof D && (A = D(t)), y.add(new Im({
                style: Wa({}, _, {
                    text: A,
                    x: T,
                    y: d / 2,
    ...
    yu(Ix.PROCESSOR.SERIES_FILTER, TS), Oy.registerSubTypeDefaulter("legend", function () {
        return "plain"
    });
    var CS = wS.extend({
        type: "legend.scroll",
        ...
        init: function (t, e, n, i) {
            var r = $o(t);
            CS.superCall(this, "init", t, e, n, i), tf(this, t, r)
        },
        mergeOption: function (t, e) {
            CS.superCall(this, "mergeOption", t, e), tf(this, this.option, t)
        }
    }), DS = hg, AS = ["width", "height"], kS = ["x", "y"], PS = IS.extend({
        type: "legend.scroll", newlineDisabled: !0, init: function () {
            PS.superCall(this, "init"), this._currentIndex = 0, this.group.add(this._containerGroup = new DS), this._containerGroup.add(this.getContentGroup()), this.group.add(this._controllerGroup = new DS), this._showController
        }, resetInner: function () {
            PS.superCall(this, "resetInner"), this._controllerGroup.removeAll(), this._containerGroup.removeClipPath(), this._containerGroup.__rectSize = null
        }, renderInner: function (t, e, n, i, r, a, o) {
            function s(t, n) {
                var r = t + "DataIndex",
                    a = so(e.get("pageIcons", !0)[e.getOrient().name][n], {onclick: y(l._pageGo, l, r, e, i)}, {
                        x: -h[0] / 2,
                        y: -h[1] / 2,
                        width: h[0],
                        height: h[1]
            ...
            var s = this.getSelectorGroup(), l = t.getOrient().index, u = AS[l], h = kS[l], c = AS[1 - l],
                d = kS[1 - l];
            ...
            ky(t.get("orient"), s, t.get("itemGap"), i ? n.width : null, i ? null : n.height), ky("horizontal", u, t.get("pageButtonItemGap", !0));
            ...
            if (y[r] = d ? n[r] : h[r], y[a] = Math.max(h[a], c[a]), y[o] = Math.min(0, c[o] + g[1 - i]), l.__rectSize = n[r], d) {
                var _ = {x: 0, y: 0};
                _[r] = Math.max(n[r] - c[r] - v, 0), _[a] = y[a], l.setClipPath(new Rm({shape: _})), l.__rectSize = _[r]
            } else u.eachChild(function (t) {
                t.attr({invisible: !0, silent: !0})
            });
            var x = this._getPageInfo(t);
            return null != x.pageIndex && Ja(s, {position: x.contentPosition}, d ? t : !1), this._updatePageInfoView(t, x), y
            ...
            var i = t.get("scrollDataIndex", !0), r = this.getContentGroup(), a = this._containerGroup.__rectSize,
                o = t.getOrient().index, s = AS[o], l = kS[o], u = this._findTargetItemIndex(i), h = r.children(),
    ...
    xu("legendScroll", "legendscroll", function (t, e) {
    ...
    var LS = function (t, e) {
        ...
        return {point: i, el: s}
    }, OS = f, BS = _, ES = lr(), zS = function (t, e, n) {
        var i = t.currTrigger, r = [t.x, t.y], a = t, o = t.dispatchAction || y(n.dispatchAction, n),
            s = e.getComponent("axisPointer").coordSysAxesInfo;
        if (s) {
            cf(r) && (r = LS({seriesIndex: a.seriesIndex, dataIndex: a.dataIndex}, e).point);
            var l = cf(r), u = a.axesInfo, h = s.axesInfo, c = "leave" === i || cf(r), d = {}, f = {},
                p = {list: [], map: {}}, g = {showPointer: BS(rf, f), showTooltip: BS(af, p)};
            OS(s.coordSysMap, function (t, e) {
                var n = l || t.containPoint(r);
                OS(s.coordSysAxesInfo[e], function (t) {
                    var e = t.axis, i = uf(u, t);
                    if (!c && n && (!u || i)) {
                        var a = i && i.value;
                        null != a || l || (a = e.pointToData(r)), null != a && ef(t, a, g, !1, d)
                    }
                })
            });
            var v = {};
            return OS(h, function (t, e) {
                var n = t.linkGroup;
                n && !f[e] && OS(n.axesInfo, function (e, i) {
                    var r = f[i];
                    if (e !== t && r) {
                        var a = r.value;
                        n.mapper && (a = t.axis.scale.parse(n.mapper(a, hf(e), hf(t)))), v[t.key] = a
                    }
                })
            }), OS(v, function (t, e) {
                ef(h[e], t, g, !0, d)
            }), of(f, h, d), sf(p, r, t, o), lf(h, o, n), d
        }
    }, RS = (Cu({
        type: "axisPointer",
        ...
        type: "axisPointer", render: function (t, e, n) {
            ...
            yf(e.getZr(), "axisPointer"), FS.superApply(this._model, "remove", arguments)
        }, dispose: function (t, e) {
            yf("axisPointer", e), FS.superApply(this._model, "dispose", arguments)
        }
    }), VS = lr(), HS = i, GS = y;
    _f.prototype = {
        _group: null,
        ...
        render: function (t, e, n, i) {
            ...
            if (this._axisModel = t, this._axisPointerModel = e, this._api = n, i || this._lastValue !== r || this._lastStatus !== a) {
                ...
                } else o = this._group = new hg, this.createPointerEl(o, l, t, e), this.createLabelEl(o, l, t, e), n.getZr().add(o);
                Mf(o, e, !0), this._renderHandle(r)
            }
        },
        remove: function (t) {
            this.clear(t)
        ...
        determineAnimation: function (t, e) {
            ...
            if ("auto" === n || null == n) {
                ...
                if (a) {
                    var s = od(t).seriesDataCount, l = i.getExtent();
        ...
        updateLabelEl: function (t, e, n, i) {
            var r = VS(t).labelEl;
            r && (r.setStyle(e.label.style), n(r, {shape: e.label.shape, position: e.label.position}), bf(r, i))
        },
        _renderHandle: function (t) {
            if (!this._dragging && this.updateHandleTransform) {
                ...
                var l = r.get("size");
                x(l) || (l = [l, l]), i.attr("scale", [l[0] / 2, l[1] / 2]), gl(this, "_doDispatchAxisPointer", r.get("throttle") || 0, "fixRate"), this._moveHandleToValue(t, o)
            }
        },
        ...
        _onHandleDragMove: function (t, e) {
            ...
            if (n) {
                ...
                this._payloadInfo = i, n.stopAnimation(), n.attr(Sf(i)), VS(n).lastProp = null, this._doDispatchAxisPointer()
            }
        },
    ...
    }, _f.prototype.constructor = _f, vr(_f);
    var WS = _f.extend({
        ...
        line: function (t, e, n) {
            ...
            return {type: "Rect", shape: Lf([e - i / 2, n[0]], [i, r], Bf(t))}
        }
    };
    Bb.registerAxisPointerClass("CartesianAxisPointer", WS), mu(function (t) {
        if (t) {
            (!t.axisPointer || 0 === t.axisPointer.length) && (t.axisPointer = {});
            var e = t.axisPointer.link;
            e && !x(e) && (t.axisPointer.link = [e])
        }
    }), yu(Ix.PROCESSOR.STATISTIC, function (t, e) {
    ...
    var YS = f, US = No, qS = ["", "-webkit-", "-moz-", "-o-"],
    ...
    Ff.prototype = {
        constructor: Ff, _enterable: !0, update: function () {
            ...
            e.style.cssText = jS + Rf(t) + ";left:" + n[0] + "px;top:" + n[1] + "px;" + (t.get("extraCssText") || ""), e.style.display = e.innerHTML ? "block" : "none", e.style.pointerEvents = this._enterable ? "auto" : "none", this._show = !0
        ...
        constructor: Vf, _enterable: !0, update: function () {
        }, show: function () {
    ...
    var ZS = y, KS = f, $S = wo, QS = new Rm({shape: {x: -1, y: -1, width: 2, height: 2}});
    Du({
        type: "tooltip", init: function (t, e) {
            if (!Kf.node) {
                ...
                var r;
                "html" === this._renderMode ? (r = new Ff(e.getDom(), e, {appendToBody: n.get("appendToBody", !0)}), this._newLine = "<br/>") : (r = new Vf(e), this._newLine = "\n"), this._tooltipContent = r
            }
        }, render: function (t, e, n) {
            if (!Kf.node) {
            ...
            if (i.from !== this.uid && !Kf.node) {
                ...
                if (i.tooltip && null != i.x && null != i.y) {
                    ...
                    var s = LS(i, e), l = s.point[0], u = s.point[1];
            ...
            if (null != r && null != a && null != o) {
                ...
                if (s) {
                    var l = s.getData(), t = Hf([l.getItemModel(a), s, (s.coordinateSystem || {}).model, t]);
            ...
            var n = this._ecModel, i = this._tooltipModel, a = [e.offsetX, e.offsetY], o = [], s = [],
                l = Hf([e.tooltipOption, i]), u = this._renderMode, h = this._newLine, c = {};
            KS(t, function (t) {
                KS(t.dataByAxis, function (t) {
            ...
            var a = new fo(i, this._tooltipModel, this._ecModel), o = a.get("content"), s = Math.random();
            ...
            if (o && d.applyTransform(o.transform), "function" == typeof e && (e = e([n, i], a, r.el, d, {
                viewSize: [s, l],
                contentSize: u.slice()
            })), x(e)) n = $S(e[0], s), i = $S(e[1], l); else if (S(e)) {
            ...
            return n && KS(e, function (e, i) {
                var r = e.dataByAxis || {}, a = t[i] || {}, o = a.dataByAxis || [];
                n &= r.length === o.length, n && KS(r, function (t, e) {
                    var i = o[e] || {}, r = t.seriesDataIndices || [], a = i.seriesDataIndices || [];
                    n &= t.value === i.value && t.axisType === i.axisType && t.axisId === i.axisId && r.length === a.length, n && KS(r, function (t, e) {
                        var i = a[e];
    ...
    }), xu({type: "showTip", event: "showTip", update: "tooltip:manuallyShowTip"}, function () {
    }), xu({type: "hideTip", event: "hideTip", update: "tooltip:manuallyHideTip"}, function () {
